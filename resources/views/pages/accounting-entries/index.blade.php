...
@section('subcontent')
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12">
            <div class="box p-5">
                <form method="GET" action="{{ route('accounting_entries.index') }}">
                    <div class="flex flex-col sm:flex-row gap-4 items-end">
                        <div class="flex-1">
                            <label class="form-label">{{ __('global.search') }}</label>
                            <x-base.form-input name="search" type="text" placeholder="{{ __('global.search') }}..." class="w-full" value="{{ request('search') }}" />
                        </div>
                        <div>
                             <label class="form-label">{{ __('accounting_entries.fields.entry_date') }}</label>
                            <x-base.form-input name="entry_date" type="date" class="w-full" value="{{ request('entry_date') }}" />
                        </div>
                        <div class="flex gap-2">
