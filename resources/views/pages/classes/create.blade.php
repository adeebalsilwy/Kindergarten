                ...
                <form action="{{ route('classes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input type="text" name="name" id="name" value="{{ old('name') }}" class="mt-2" placeholder="{{ __('classes.placeholders.name') }}" />
                            @error('name')
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input type="text" name="code" id="code" value="{{ old('code') }}" class="mt-2" placeholder="{{ __('classes.placeholders.code') }}" />
                            @error('code')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-span-12">
                            ...
                            <x-base.form-textarea name="description" id="description" rows="4" class="resize-none">{{ old('description') }}</x-base.form-textarea>
                            @error('description')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.tom-select name="age_group" id="age_group" class="mt-2">
                                <option value="">{{ __('global.select_option') }}</option>
                                <option value="toddlers" {{ old('age_group') == 'toddlers' ? 'selected' : '' }}>{{ __('classes.age_groups.toddlers') }}</option>
                                <option value="preschool" {{ old('age_group') == 'preschool' ? 'selected' : '' }}>{{ __('classes.age_groups.preschool') }}</option>
                                <option value="pre_k" {{ old('age_group') == 'pre_k' ? 'selected' : '' }}>{{ __('classes.age_groups.pre_k') }}</option>
                                <option value="kindergarten" {{ old('age_group') == 'kindergarten' ? 'selected' : '' }}>{{ __('classes.age_groups.kindergarten') }}</option>
                            </x-base.tom-select>
                            @error('age_group')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input type="number" name="capacity" id="capacity" value="{{ old('capacity') }}" class="mt-2" placeholder="{{ __('classes.placeholders.capacity') }}" />
                            @error('capacity')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input type="number" name="current_students" id="current_students" value="{{ old('current_students') }}" class="mt-2" placeholder="{{ __('classes.placeholders.current_students') }}" />
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <div class="relative mt-2">
                                <x-base.form-input type="time" name="start_time" id="start_time" value="{{ old('start_time') }}" />
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <div class="relative mt-2">
                                <x-base.form-input type="time" name="end_time" id="end_time" value="{{ old('end_time') }}" />
                                <div class="absolute inset-y-0 right-0 pe-3 flex items-center pointer-events-none">
                                    <x-base.lucide icon="Clock" class="h-5 w-5 text-gray-400" />
                                </div>
                            </div>
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input type="text" name="room_number" id="room_number" value="{{ old('room_number') }}" class="mt-2" placeholder="{{ __('classes.placeholders.room_number') }}" />
                            @error('room_number')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input type="number" step="0.01" name="monthly_fee" id="monthly_fee" value="{{ old('monthly_fee') }}" class="mt-2" placeholder="{{ __('classes.placeholders.monthly_fee') }}" />
                            @error('monthly_fee')
                                <div class="text-danger mt-2">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <x-base.form-input type="text" name="schedule" id="schedule" value="{{ old('schedule') }}" class="mt-2" placeholder="{{ __('classes.placeholders.schedule') }}" />
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            <x-base.form-label>{{ __('classes.fields.location') }}</x-base.form-label>
                            <x-base.form-input type="text" name="location" id="location" value="{{ old('location') }}" class="mt-2" placeholder="{{ __('classes.placeholders.location') }}" />
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            <x-base.form-label>{{ __('classes.fields.start_date') }}</x-base.form-label>
                            <x-base.form-input type="date" name="start_date" id="start_date" value="{{ old('start_date') }}" class="mt-2" />
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            <x-base.form-label>{{ __('classes.fields.end_date') }}</x-base.form-label>
                            <x-base.form-input type="date" name="end_date" id="end_date" value="{{ old('end_date') }}" class="mt-2" />
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <div class="mt-2 space-y-2">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    <x-base.form-input type="checkbox" name="is_active" value="1" {{ old('is_active') ? 'checked' : '' }} class="sr-only peer" />
