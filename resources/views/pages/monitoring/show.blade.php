...
@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium me-auto">Command Log: #{{ $log->id }}</h2>
        <x-base.button variant="outline-secondary" as="a" href="{{ route('monitoring.index') }}" class="w-24 me-2">Back</x-base.button>
    </div>
