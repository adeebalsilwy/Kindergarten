                        ...
                        <x-base.table.tr class="intro-x">
                            ...
                            <x-base.table.td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    @can('view_jobs')
                                    <x-base.button variant="outline-secondary" as="a" href="{{ route('jobs.show', $job->id) }}" size="sm" class="mr-2">
                                    ...
                                    @can('edit_jobs')
                                    <x-base.button variant="outline-primary" as="a" href="{{ route('jobs.edit', $job->id) }}" size="sm" class="mr-2">
