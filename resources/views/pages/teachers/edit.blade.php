...
@section('head')
    <title>{{ __('Teacher.edit') }} - Laravel</title>
@endsection
            ...
            <div class="intro-y box p-5">
                <form action="{{ route('teachers.update', $teacher->id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <div class="relative mt-2">
                                ...
                                <x-base.form-input type="number" step="0.01" min="0" name="salary" value="{{ old('salary', $teacher->salary ?? '') }}" class="ps-12" />
                            </div>
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                    ...
                    <div class="flex justify-end mt-5">
                        <a href="{{ route('teachers.index') }}" class="btn btn-outline-secondary w-24 me-1">{{ __('global.cancel') }}</a>
