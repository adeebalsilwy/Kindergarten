            ...
            <form action="{{ route('roles.assign-permissions') }}" method="POST">
                ...
                <div class="modal-body p-10">
                    <div class="grid grid-cols-12 gap-6">
                        ...
                        <div class="col-span-12">
                            <x-base.form-label class="font-bold">{{ __('access_control.fields.permissions') }}</x-base.form-label>
                                ...
                                @foreach($allPermissions as $permission)
                                    <div class="col-span-12 md:col-span-4 lg:col-span-3">
                                        <div class="flex items-center p-1">
                                            ...
                                            />
                                            <x-base.form-check.label for="perm_{{ $permission->id }}" class="ms-2 text-xs cursor-pointer">
                                                {{ $permission->name }}
