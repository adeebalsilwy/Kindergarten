...
<head>
    ...
    <title>{{ __('financial-reports.title') }} - {{ config('app.name') }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>{{ __('financial-reports.title') }} - {{ __('global.export_excel') }}</p>
        </div>
...
{{tableHeaders}}
            ...
            <tbody>
                @foreach(${{'{{variableNamePlural}}'}} as ${{'financialReports'}})
                <tr>
{{tableBody}}
                </tr>
                @endforeach
