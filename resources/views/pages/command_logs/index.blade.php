...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium me-auto">{{ __('CommandLog.list') }}</h2>
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            ...
            <x-base.button variant="primary" as="a" href="{{ route('command_logs.create') }}" class="ms-2 flex items-center">
                        ...
                        <x-base.table.tr class="intro-x">
                            ...
                            <x-base.table.td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    <x-base.button variant="outline-secondary" as="a" href="{{ route('command_logs.show', $commandLog->id) }}" size="sm" class="me-2">
                                    ...
                                    <x-base.button variant="outline-primary" as="a" href="{{ route('command_logs.edit', $commandLog->id) }}" size="sm" class="me-2">
