...
@section('head')
    <title>{{ __('childrens.edit') }} - {{ config('app.name') }}</title>
    <style>
...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium me-auto">{{ __('childrens.edit') }}</h2>
...
<div class="grid grid-cols-12 gap-6 mt-5">
    <div class="intro-y col-span-12">
        ...
        <form action="{{ route('children.update', $children->id) }}" method="POST" enctype="multipart/form-data" class="intro-y box p-5" id="children-edit-form">
            @csrf
            @method('PUT')
                ...
                <x-form-section title="{{ __('childrens.sections.personal_info') }}" 
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <x-form-field name="nationality" 
                                     ...
                                     type="text" 
                                     :value="old('nationality', $children->nationality ?? '')" 
                        ...
                        <x-form-field name="religion" 
                                     ...
                                     type="text" 
                                     :value="old('religion', $children->religion ?? '')" 
                ...
                <x-form-section title="{{ __('childrens.sections.parent_info') }}" 
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <x-form-field name="second_parent_id" 
                                     ...
                                     type="select" 
                                     :value="old('second_parent_id', $children->second_parent_id ?? '')" 
                                     :options="$parents->pluck('name', 'id')" 
                                     placeholder="{{ __('global.select_option') }}" 
                                     class="col-span-12" 
                ...
                <x-form-section title="{{ __('childrens.sections.medical_info') }}" 
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <x-form-field name="blood_type" 
                                     ...
                                     type="select" 
                                     :value="old('blood_type', $children->blood_type ?? '')" 
                                     :options="[
                                         'A+' => 'A+', 'A-' => 'A-',
                                         'B+' => 'B+', 'B-' => 'B-',
                                         'AB+' => 'AB+', 'AB-' => 'AB-',
                        ...
                        <x-form-field name="medical_conditions" 
                                     ...
                                     type="textarea" 
                                     :value="old('medical_conditions', $children->medical_conditions ?? '')" 
                        ...
                        <x-form-field name="allergies" 
                                     ...
                                     type="textarea" 
                                     :value="old('allergies', $children->allergies ?? '')" 
                        ...
                        <x-form-field name="medications" 
                                     ...
                                     type="textarea" 
                                     :value="old('medications', $children->medications ?? '')" 
                        ...
                        <x-form-field name="special_needs" 
                                     ...
                                     type="textarea" 
                                     :value="old('special_needs', $children->special_needs ?? '')" 
                ...
                <x-form-section title="{{ __('childrens.sections.financial_info') }}" 
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <x-form-field name="fees_required" 
                                     ...
                                     step="0.01" 
                                     min="0" 
                                     :value="old('fees_required', $children->fees_required ?? '')" 
                        ...
                        <x-form-field name="fees_paid" 
                                     ...
                                     step="0.01" 
                                     min="0" 
                                     :value="old('fees_paid', $children->fees_paid ?? '')" 
                                     addon="{{ config('app.currency', 'USD') }}" 
                                     class="col-span-12 sm:col-span-6" />
                    </div>
                </x-form-section>
                ...
                <x-form-section title="{{ __('childrens.sections.enrollment_info') }}" 
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        <x-form-field name="enrollment_date" 
                                     ...
                                     type="date" 
                                     :value="old('enrollment_date', optional($children->enrollment_date)->format('Y-m-d'))" 
                                     class="col-span-12 sm:col-span-6" />
                        
                        <x-form-field name="expected_graduation_date" 
                                     label="{{ __('childrens.fields.expected_graduation_date') }}" 
                                     type="date" 
                                     :value="old('expected_graduation_date', optional($children->expected_graduation_date)->format('Y-m-d'))" 
                                     class="col-span-12 sm:col-span-6" />
                        
                        <x-form-field name="enrollment_status" 
                                     label="{{ __('childrens.fields.enrollment_status') }}" 
                                     type="select" 
                                     :value="old('enrollment_status', $children->enrollment_status ?? 'active')" 
                                     :options="[
                        ...
                        <x-form-field name="last_attended_at" 
                                     ...
                                     type="datetime-local" 
                                     :value="old('last_attended_at', optional($children->last_attended_at)->format('Y-m-d\TH:i'))" 
                                     class="col-span-12 sm:col-span-6" />
                    </div>
                </x-form-section>
            </div>
