    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-10">
            <div class="intro-y box p-5">
                <form action="{{ route('cache.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="flex justify-end mt-5">
                        <a href="{{ route('cache.index') }}" class="btn btn-outline-secondary w-24 me-1">{{ __('global.cancel') }}</a>
