...
@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium me-auto">{{ __('DashboardContent.edit') }}</h2>
    </div>
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-10">
            <div class="intro-y box p-5">
                <form action="{{ route('dashboard_contents.update', $dashboardContent->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
