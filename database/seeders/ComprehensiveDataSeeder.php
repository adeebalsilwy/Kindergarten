...
class ComprehensiveDataSeeder extends Seeder
{
    ...
    {
        $this->command->info('Starting comprehensive data seeding for Yemeni kindergarten system...');

        // Create roles first
        $roles = ['مدير النظام', 'المدير', 'معلم', 'أولياء الأمور', 'محاسب', 'طاقم العمل', 'الإدارة العليا'];
        ...
        $superAdmin->assignRole('الإدارة العليا');

        // Create sample users with different roles
        $users = [
            [
                'name' => 'أحمد محمد عبدالله القائسي',
                'email' => 'admin@روضة.الى',
            ...
            [
                'name' => 'محمد خالد سعيد القائسي',
                'email' => 'accountant@روضة.الى',
                'plain_password' => 'admin123',
                'phone' => '+967773456789',
            ...
            [
                'name' => 'نورا أحمد محمد السلوي',
                'email' => 'staff@روضة.الى',
                'plain_password' => 'admin123',
                'phone' => '+967774567890',
            ...
            [
                ...
                'email' => 'parent@روضة.الى',
                'plain_password' => 'admin123',
                'phone' => '+967779999999',
                'address' => 'صنعاء - سبعين - شارع تعز',
                'role' => 'أولياء الأمور',
            ],
        ];
        ...
        $professionalTeachers = [
            ...
            [
                ...
                'email' => 'fatima.alradmani@روضة.الى',
                'phone' => '+967777777777',
        ...
        // Create comprehensive classes with Arabic names and descriptions
        $classData = [
            [
        ...
        $arabicMaleNames = [
            ...
            'سفيان', 'أيمن', 'رضا', 'مروان', 'حسام', 'إياد', 'جهاد', 'أشرف', 'رائف', 'نبيل'
        ];
        ...
        $subjects = [
            ...
            'تطوير اللغة', 'حل المشكلات', 'التعاون', 'الاستقلالية'
        ];
        
        $gradeSystems = [
            // Numeric scores
            ['Excellent' => 95, 'Very Good' => 85, 'Good' => 75, 'Acceptable' => 65, 'Weak' => 45],
            // Letter grades
            ['A+' => 95, 'A' => 90, 'B+' => 85, 'B' => 80, 'C+' => 75, 'C' => 70, 'D' => 60, 'F' => 45],
            // Percentage
            ['Outstanding' => 95, 'Excellent' => 90, 'Very Good' => 85, 'Good' => 75, 'Satisfactory' => 65, 'Needs Improvement' => 55]
        ];
        ...
        foreach ($createdChildren as $child) {
            ...
            for ($i = 0; $i < rand(4, 8); $i++) {
                ...
                Grade::create([
                    ...
                    'comments' => ['Shows great improvement', 'Needs more practice', 'Excellent participation', 'Good effort', 'Could improve'][rand(0, 4)],
        ...
        // Create diverse activities with English content
        ...
        foreach ($createdClasses as $class) {
            ...
            for ($i = 0; $i < rand(8, 12); $i++) {
                ...
                Activity::updateOrCreate(
                    ['title' => ['Color Mixing Art', 'Number Games', 'Story Circle', 'Music and Movement', 'Building Blocks Challenge', 'Nature Walk', 'Drama Play', 'Cooking Activity', 'Science Experiment', 'Puzzle Time'][rand(0, 9)], 'scheduled_date' => $scheduledDate],
                    [
                        'description' => 'Engaging activity for children to learn and develop skills',
                        'instructions' => 'Follow the planned activity guidelines',
                        'class_id' => $class->id,
                        ...
                        'required_materials' => (function($arr, $num) { shuffle($arr); return array_slice($arr, 0, $num); })(['Pencils', 'Paper', 'Scissors', 'Glue', 'Colors', 'Blocks', 'Musical Instruments'], rand(2, min(5, 7))),
                        'estimated_duration' => rand(30, 120), // minutes
                        'location' => ['Classroom', 'Playground', 'Art Room', 'Library', 'Garden'][rand(0, 4)],
                        'is_active' => true,
                        'learning_objectives' => (function($arr, $num) { shuffle($arr); return array_slice($arr, 0, $num); })(['Cognitive development', 'Motor skills', 'Social interaction', 'Creativity'], rand(2, min(3, 4))),
                        'outcomes' => (function($arr, $num) { shuffle($arr); return array_slice($arr, 0, $num); })(['Improved skills', 'Knowledge gained', 'Confidence building'], rand(1, min(2, 3))),
                        'assessment_criteria' => (function($arr, $num) { shuffle($arr); return array_slice($arr, 0, $num); })(['Participation', 'Completion', 'Creativity', 'Teamwork'], rand(2, min(3, 4))),
        ...
        // Create diverse events with English content
        ...
        foreach ($createdClasses as $class) {
            ...
            for ($i = 0; $i < rand(4, 6); $i++) {
                ...
                Event::updateOrCreate(
                    ['title' => ['Field Trip to Zoo', 'Parent-Teacher Meeting', 'Children Performance', 'National Day Celebration', 'Art Workshop', 'Sports Day', 'Science Fair', 'Story Telling Session'][rand(0, 7)], 'start_datetime' => $startDate],
                    [
                        'description' => 'Special event for children and families',
                        ...
                        'class_id' => $class->id,
                        'teacher_id' => $class->teacher_id,
                        'attendees' => (function($arr, $num) { shuffle($arr); return array_slice($arr, 0, $num); })(['children', 'parents', 'teachers', 'guests'], rand(1, min(3, 4))),
        ...
        foreach ($payments as $payment) {
            if ($payment->child) {
                AccountingEntry::create([
                    'description' => 'Payment received from '.$payment->child->name,
                    'debit' => 0,
        ...
        foreach (Expense::all() as $expense) {
            AccountingEntry::create([
                'description' => 'Expense for '.$expense->category.' - '.$expense->vendor,
        ...
        foreach ($createdTeachers as $teacher) {
            for ($month = 0; $month < 3; $month++) {
                AccountingEntry::create([
                    'description' => 'Teacher salary for '.$teacher->name,
        ...
        AccountingEntry::create([
            'description' => 'Purchase of educational equipment',
            'debit' => 250000,
            'credit' => 0,
        ...
        // Create kindergarten-specific materials
        $kindergartenMaterials = [
            // Arts and Crafts Materials
            [
                'name' => 'Colors and Paints',
                'description' => 'Non-toxic watercolors and paints for children activities',
                ...
                'storage_location' => 'Art Room Cabinet A',
                'is_consumable' => true,
                'is_digital' => false,
                'is_active' => true,
            ],
            [
                'name' => 'Drawing Paper',
                'description' => 'High-quality drawing paper for children artwork',
                'category' => 'arts_crafts',
                'type' => 'consumable',
                ...
                'storage_location' => 'Art Room Cabinet B',
                'is_consumable' => true,
                'is_digital' => false,
                'is_active' => true,
            ],
            [
                'name' => 'Crayons',
                'description' => 'Washable crayons for children use',
                'category' => 'arts_crafts',
                'type' => 'consumable',
                ...
                'storage_location' => 'Classroom Drawer',
                'is_consumable' => true,
                'is_digital' => false,
                'is_active' => true,
            ],
            [
                ...
                'description' => 'Child-safe scissors for craft activities',
                'category' => 'arts_crafts',
                'type' => 'reusable',
            ...
            [
                'name' => 'Glue Sticks',
                'description' => 'Washable glue sticks for paper crafts',
                'category' => 'arts_crafts',
                'type' => 'consumable',
            ...
            [
                ...
                'description' => 'Wooden building blocks for spatial learning',
                'category' => 'educational_toys',
                'type' => 'reusable',
                'quantity_available' => 15,
                'quantity_required' => 10,
                'unit_cost' => 25.00,
                'supplier' => 'Toy Manufacturing Co.',
                'storage_location' => 'Play Area Shelf',
                'is_consumable' => false,
                'is_digital' => false,
                'is_active' => true,
            ],
            [
                'name' => 'Shape Sorter',
                'description' => 'Shape sorting toy for cognitive development',
                'category' => 'educational_toys',
                'type' => 'reusable',
                'quantity_available' => 12,
                'quantity_required' => 8,
                'unit_cost' => 15.00,
                'supplier' => 'Educational Toys Co.',
                'storage_location' => 'Play Area Toy Box',
                'is_consumable' => false,
                'is_digital' => false,
                'is_active' => true,
            ],
            [
                'name' => 'Counting Bears',
                'description' => 'Colorful counting bears for math activities',
                'category' => 'educational_toys',
                'type' => 'reusable',
                'quantity_available' => 8,
                'quantity_required' => 6,
                'unit_cost' => 12.00,
                'supplier' => 'Math Learning Co.',
                'storage_location' => 'Math Corner',
                'is_consumable' => false,
                'is_digital' => false,
                'is_active' => true,
            ],
            [
                'name' => 'Puzzles',
                'description' => 'Age-appropriate puzzles for problem solving',
                'category' => 'educational_toys',
                'type' => 'reusable',
                'quantity_available' => 20,
                'quantity_required' => 15,
                'unit_cost' => 8.00,
                'supplier' => 'Puzzle Manufacturer',
                'storage_location' => 'Quiet Area Shelf',
                'is_consumable' => false,
                'is_digital' => false,
                'is_active' => true,
            ],
            ...
            [
                'name' => 'Picture Books',
                'description' => 'Age-appropriate picture books for story time',
                'category' => 'reading_materials',
                'type' => 'reusable',
                'quantity_available' => 60,
                'quantity_required' => 50,
                'unit_cost' => 7.00,
                'supplier' => 'Book Publisher Co.',
                'storage_location' => 'Library Corner',
                'is_consumable' => false,
                'is_digital' => false,
                'is_active' => true,
            ],
            [
                'name' => 'ABC Learning Cards',
                'description' => 'Alphabet cards for letter recognition',
                'category' => 'reading_materials',
                'type' => 'reusable',
                'quantity_available' => 10,
                'quantity_required' => 8,
                'unit_cost' => 5.00,
                'supplier' => 'Educational Materials Co.',
                'storage_location' => 'Reading Nook',
                'is_consumable' => false,
                'is_digital' => false,
                'is_active' => true,
            ],
            [
                ...
                'description' => 'Phonics flashcards for sound learning',
                'category' => 'reading_materials',
                'type' => 'reusable',
                'quantity_available' => 15,
                'quantity_required' => 12,
                'unit_cost' => 4.00,
                'supplier' => 'Reading Aid Co.',
                'storage_location' => 'Literacy Center',
                'is_consumable' => false,
                'is_digital' => false,
                'is_active' => true,
            ],
            ...
            [
                ...
                'description' => 'Child-sized musical instruments',
                'category' => 'music_movement',
                'type' => 'reusable',
                'quantity_available' => 15,
                'quantity_required' => 12,
                'unit_cost' => 20.00,
                'supplier' => 'Music Equipment Co.',
                'storage_location' => 'Music Corner',
                'is_consumable' => false,
                'is_digital' => false,
                'is_active' => true,
            ],
            [
                ...
                'description' => 'Light scarves for movement activities',
                'category' => 'music_movement',
                'type' => 'reusable',
                'quantity_available' => 20,
                'quantity_required' => 15,
                'unit_cost' => 3.00,
                'supplier' => 'Movement Equipment Co.',
                'storage_location' => 'Dance Area',
                'is_consumable' => false,
                'is_digital' => false,
                'is_active' => true,
            ],
            ...
            [
                'name' => 'Tablet Apps License',
                'description' => 'Educational apps for tablets',
            ...
            [
                'name' => 'Interactive Whiteboard Content',
                'description' => 'Educational content for interactive whiteboards',
                'category' => 'digital_learning',
                'type' => 'digital',
                'quantity_available' => 5,
                'quantity_required' => 5,
                'unit_cost' => 100.00,
                'supplier' => 'Education Software Co.',
        ...
        foreach ($kindergartenMaterials as $materialData) {
            $material = \App\Models\Material::create(array_merge($materialData, [
                'created_by' => $createdUsers->random()->id,
                'created_at' => Carbon::now(),
                'updated_at' => Carbon::now(),
            ]));
            
            // Randomly assign materials to curricula
            if (rand(1, 3) !== 1 && $createdCurricula->count() > 0) {
                $randomCurricula = $createdCurricula->random(rand(1, min(2, $createdCurricula->count())));
                foreach ($randomCurricula as $curriculum) {
                    $material->curricula()->attach($curriculum->id, [
                        'quantity_required' => rand(1, 5),
                        'usage_instructions' => 'Used in various activities throughout the curriculum'
                    ]);
                }
            }
        }

        $this->command->info('Comprehensive Yemeni kindergarten data has been successfully seeded!');
