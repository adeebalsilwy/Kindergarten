...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['class' => 'inline h-5 w-5 me-2 '.e($colorClass).'','icon' => ''.e($icon).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'inline h-5 w-5 me-2 '.e($colorClass).'','icon' => ''.e($icon).'']); ?>
...
<?php endif; ?>
        ...
        <?php if($route && $showViewAll): ?>
            <a href="<?php echo e(route($route)); ?>" class="text-<?php echo e($color); ?> truncate ms-auto">
                <?php echo e(__('global.view_all')); ?>

                <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['class' => 'inline h-4 w-4 ms-1','icon' => 'ArrowRight']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.lucide'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'inline h-4 w-4 ms-1','icon' => 'ArrowRight']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800)): ?>
<?php $attributes = $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800; ?>
...
<?php endif; ?>
                        ...
                        <?php if(isset($item['amount'])): ?>
                            <div class="ms-2 font-medium <?php echo e($item['amount'] > 0 ? 'text-success' : 'text-danger'); ?>">
...
<?php endif; ?>
    ...
    <?php endif; ?>
</div><?php /**PATH E:\backup\Source\resources\views\components\widgets\list-card.blade.php ENDPATH**/ ?>