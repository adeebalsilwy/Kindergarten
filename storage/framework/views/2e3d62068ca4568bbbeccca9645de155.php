...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.breadcrumb.index','data' => ['class' => \Illuminate\Support\Arr::toCssClasses([
                'h-[45px] md:ms-10 md:border-l border-white/[0.08] dark:border-white/[0.08] me-auto -intro-x',
                'md:ps-6' => $layout != 'top-menu',
                'md:ps-10' => $layout == 'top-menu',
            ]),'light' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-input.index','data' => ['class' => 'w-56 rounded-full border-transparent bg-slate-200 pe-8 shadow-none transition-[width] duration-300 ease-in-out focus:w-72 focus:border-transparent dark:bg-darkmode-400','type' => 'text','placeholder' => 'Search...']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-56 rounded-full border-transparent bg-slate-200 pe-8 shadow-none transition-[width] duration-300 ease-in-out focus:w-72 focus:border-transparent dark:bg-darkmode-400','type' => 'text','placeholder' => 'Search...']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php if (! $__env->hasRenderedOnce('37ac3c75-efb2-4cf7-b49d-f81eb03433be')): $__env->markAsRenderedOnce('37ac3c75-efb2-4cf7-b49d-f81eb03433be');
$__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/components/themes/enigma/top-bar.js'); ?>
<?php $__env->stopPush(); endif; ?>
<?php /**PATH E:\backup\Source\resources\views\components\themes\enigma\top-bar\index.blade.php ENDPATH**/ ?>