...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium me-auto"><?php echo e(__('global.view_dashboard_content')); ?></h2>
</div>
        ...
        <div class="tab-content mt-5">
            <div class="tab-pane active" id="content-details">
                <div class="box p-5">
                    ...
                    <div class="mt-5">
                        <a href="<?php echo e(route('dashboard-content.index')); ?>" class="btn btn-outline-secondary w-24 me-1"><?php echo e(__('global.back')); ?></a>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\backup\Source\resources\views\pages\dashboard-content\show.blade.php ENDPATH**/ ?>