                ...
                <div class="col-span-12 mt-8 lg:col-span-6">
                    <div class="intro-y block h-10 items-center sm:flex">
                        ...
                        <div class="relative mt-3 text-slate-500 sm:ms-auto sm:mt-0">
                            <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['class' => 'absolute inset-y-0 left-0 z-10 my-auto ms-3 h-4 w-4','icon' => 'Calendar']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.lucide'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'absolute inset-y-0 left-0 z-10 my-auto ms-3 h-4 w-4','icon' => 'Calendar']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800)): ?>
<?php $attributes = $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.litepicker.index','data' => ['class' => 'datepicker !box ps-10 sm:w-56','type' => 'text','options' => [
                                    'format' => 'YYYY-MM-DD',
                                    'singleMode' => false,
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'datepicker !box ps-10 sm:w-56','type' => 'text','options' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute([
                                    'format' => 'YYYY-MM-DD',
                                    'singleMode' => false,
                                ])]); ?>
<?php echo $__env->renderComponent(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.menu.index','data' => ['class' => 'mt-5 md:ms-auto md:mt-0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'mt-5 md:ms-auto md:mt-0']); ?>
...
<?php $component->withAttributes(['class' => 'font-normal','as' => 'x-base.button','variant' => 'outline-secondary']); ?>
                                    ...
                                    <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['class' => 'ms-2 h-4 w-4','icon' => 'ChevronDown']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.lucide'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'ms-2 h-4 w-4','icon' => 'ChevronDown']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800)): ?>
<?php $attributes = $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800; ?>
...
<?php endif; ?>
                ...
                <div class="col-span-12 mt-8">
                    <div class="intro-y flex h-10 items-center">
                        <h2 class="me-5 truncate text-lg font-medium"><?php echo e(__('global.enrollment_statistics')); ?></h2>
                    </div>
                    <div class="intro-y box mt-5 p-5">
                                ...
                                <?php $__currentLoopData = $enrollmentStats['by_class']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classStat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <div class="flex items-center justify-between p-2 bg-slate-50 rounded">
                                        ...
                                        <div class="flex items-center space-x-4">
                                            ...
                                            <span class="text-sm w-12 text-end"><?php echo e($classStat['occupancy_rate']); ?>%</span>
                                        </div>
                                    </div>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
            ...
            <div class="-mb-10 pb-10 2xl:border-l">
                <div class="grid grid-cols-12 gap-x-6 gap-y-6 2xl:gap-x-0 2xl:ps-6">
                    ...
                    <div class="col-span-12 mt-3 md:col-span-6 xl:col-span-12 2xl:mt-8">
                        <div class="intro-y flex h-10 items-center">
                            <h2 class="me-5 truncate text-lg font-medium"><?php echo e(__('global.upcoming_events')); ?></h2>
                        </div>
                        <div class="mt-5">
...
<?php endif; ?>
                    ...
                    <div class="col-span-12 mt-3 md:col-span-6 xl:col-span-12">
                        <div class="intro-y flex h-10 items-center">
                            <h2 class="me-5 truncate text-lg font-medium"><?php echo e(__('global.recent_payments')); ?></h2>
                        </div>
                        <div class="mt-5">
...
<?php endif; ?>
    ...
    <?php $__env->stopPush(); ?>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\backup\Source\resources\views\pages\dashboard-improved.blade.php ENDPATH**/ ?>