    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th class="text-end"><?php echo e(__('global.debits')); ?></th>
                <th class="text-end"><?php echo e(__('global.credits')); ?></th>
                <th class="text-end"><?php echo e(__('global.balance')); ?></th>
...
</html><?php /**PATH E:\backup\Source\resources\views\pages\finance\exports\trial-balance-pdf.blade.php ENDPATH**/ ?>