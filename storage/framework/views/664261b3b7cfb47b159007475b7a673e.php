...
<?php $__env->startSection('subcontent'); ?>
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"><?php echo e(__('Classes.list')); ?></h2>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['icon' => 'PlusCircle','class' => 'w-4 h-4 mr-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'PlusCircle','class' => 'w-4 h-4 mr-2']); ?>
...
<?php endif; ?>
                <div class="dropdown-menu w-40">
                    <div class="dropdown-content">
                        <a href="<?php echo e(route('classes.export.pdf')); ?>" class="dropdown-item flex items-center">
                            <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
...
<?php endif; ?>
                        ...
                        <a href="<?php echo e(route('classes.export.excel')); ?>" class="dropdown-item flex items-center">
                            <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
...
<?php endif; ?>
                    ...
                    <div class="text-2xl font-bold leading-8 mt-4"><?php echo e($classes->count()); ?></div>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-input.index','data' => ['name' => 'search','value' => ''.e(request('search')).'','placeholder' => ''.e(__('global.search_classes')).'','class' => 'w-full']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'search','value' => ''.e(request('search')).'','placeholder' => ''.e(__('global.search_classes')).'','class' => 'w-full']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <select name="age_group" class="form-select w-full sm:w-40">
                            ...
                            <option value="2-3" <?php echo e(request('age_group') == '2-3' ? 'selected' : ''); ?>>2-3 <?php echo e(__('global.years')); ?></option>
                            <option value="3-4" <?php echo e(request('age_group') == '3-4' ? 'selected' : ''); ?>>3-4 <?php echo e(__('global.years')); ?></option>
                            <option value="4-5" <?php echo e(request('age_group') == '4-5' ? 'selected' : ''); ?>>4-5 <?php echo e(__('global.years')); ?></option>
                            <option value="5-6" <?php echo e(request('age_group') == '5-6' ? 'selected' : ''); ?>>5-6 <?php echo e(__('global.years')); ?></option>
                        </select>
                    ...
                    <div class="px-5 py-3 border-t border-slate-200/60 dark:border-darkmode-400">
                        <div class="space-y-2">
                            ...
                            <div class="flex justify-between text-xs">
                                ...
                                <span class="font-medium"><?php echo e($class->age_group ?? '-'); ?></span>
                            </div>
        ...
        function applyFilters() {
            ...
            cards.forEach(card => {
                ...
                const ageGroupElement = Array.from(card.querySelectorAll('.text-xs')).find(el => 
                    el.textContent.includes('<?php echo e(__('global.age_group')); ?>')
                );
...
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /app/resources/views/pages/classes/index.blade.php ENDPATH**/ ?>