...
<?php endif; ?>
                ...
                <button class="tab-button px-4 py-2 text-sm font-medium rounded-t-lg" data-tab="class-details">
                    <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['icon' => 'School','class' => 'w-4 h-4 me-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.lucide'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'School','class' => 'w-4 h-4 me-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800)): ?>
<?php $attributes = $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800; ?>
...
<?php endif; ?>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex justify-between py-2">
                                <span class="text-slate-500"><?php echo e(__('global.photo_path')); ?>:</span>
                                <span class="font-medium text-sm max-w-xs truncate"><?php echo e($children->photo_path ?? 'Not provided'); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                            <?php echo e(__('global.other_children_with_primary_parent')); ?>

                        </div>
                        <div class="space-y-2 max-h-96 overflow-y-auto">
                            <?php $__empty_1 = true; $__currentLoopData = $children->parent->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sibling): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php if($sibling->id != $children->id): ?>
                                <div class="flex items-center p-2 hover:bg-slate-50 rounded">
                                    <div class="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center me-3">
                                        <span class="text-primary text-sm font-bold"><?php echo e(strtoupper(substr($sibling->name, 0, 1))); ?></span>
                                    </div>
                                    <div class="flex-1">
                                        <div class="font-medium text-sm"><?php echo e($sibling->name); ?></div>
                                        <div class="text-xs text-slate-500"><?php echo e($sibling->age); ?> <?php echo e(__('global.years_old')); ?></div>
                                    </div>
                                    <a href="<?php echo e(route('children.show', $sibling->id)); ?>" class="text-primary hover:underline text-xs">
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                    <p class="text-sm"><?php echo e(__('global.no_other_children')); ?></p>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                            <?php echo e(__('global.other_children_with_secondary_parent')); ?>

                        </div>
                        <div class="space-y-2 max-h-96 overflow-y-auto">
                            <?php $__empty_1 = true; $__currentLoopData = $children->secondParent->children; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sibling): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <?php if($sibling->id != $children->id): ?>
                                <div class="flex items-center p-2 hover:bg-slate-50 rounded">
                                    <div class="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center me-3">
                                        <span class="text-primary text-sm font-bold"><?php echo e(strtoupper(substr($sibling->name, 0, 1))); ?></span>
...
<?php endif; ?>
                ...
                <div class="intro-y col-span-12 lg:col-span-4">
                    <div class="box p-5">
                        ...
                        <div class="space-y-2 max-h-96 overflow-y-auto">
                            <?php $__empty_1 = true; $__currentLoopData = $children->class->children->where('id', '!=', $children->id); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $classmate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <div class="flex items-center p-2 hover:bg-slate-50 rounded">
                                    <div class="w-8 h-8 rounded-full bg-primary/10 flex items-center justify-center me-3">
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left"><?php echo e(__('global.absence_reason')); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $children->attendances()->latest()->take(20)->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $attendance): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td class="text-sm text-slate-600 max-w-xs truncate"><?php echo e($attendance->absence_reason ?? '--'); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $children->grades()->latest()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $grade): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($grade->evaluator->name ?? $grade->evaluator); ?></td>
                            ...
                            <table class="table table-striped">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-left"><?php echo e(__('global.fee')); ?></th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $children->payments()->latest()->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td><?php echo e($payment->fee->name ?? 'N/A'); ?></td>
                                        </tr>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <tr>
                                            <td colspan="6" class="text-center py-8 text-slate-500">
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                            <?php echo e(optional($event->class)->name ?? 'Not assigned'); ?>
        ...
        <div id="class-details" class="tab-content">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="intro-y col-span-12">
                    <div class="box p-5">
                        <div class="text-lg font-medium mb-4 flex items-center justify-between">
                            <span><?php echo e(__('global.detailed_class_info')); ?></span>
                            <span class="text-sm text-slate-500"><?php echo e($children->class->name); ?></span>
                        </div>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                    <?php echo e(__('global.class_teacher')); ?>

                                </h3>
                                <?php if($children->class->teacher): ?>
                                    <div class="space-y-2">
                                        <div class="flex justify-between py-2 border-b">
                                            <span class="text-slate-500"><?php echo e(__('global.name')); ?>:</span>
                                            <span class="font-medium"><?php echo e($children->class->teacher->name); ?></span>
                                        </div>
                                        <div class="flex justify-between py-2 border-b">
                                            <span class="text-slate-500"><?php echo e(__('global.specialization')); ?>:</span>
                                            <span class="font-medium"><?php echo e($children->class->teacher->specialization ?? 'Not specified'); ?></span>
                                        </div>
                                        <div class="flex justify-between py-2 border-b">
                                            <span class="text-slate-500"><?php echo e(__('global.experience')); ?>:</span>
                                            <span class="font-medium"><?php echo e($children->class->teacher->experience_years ?? 0); ?> <?php echo e(__('global.years')); ?></span>
                                        </div>
                                        <div class="flex justify-between py-2">
                                            <span class="text-slate-500"><?php echo e(__('global.email')); ?>:</span>
                                            <span class="font-medium"><?php echo e($children->class->teacher->email ?? 'N/A'); ?></span>
                                        </div>
                                    </div>
                                    <div class="mt-4">
                                        <a href="<?php echo e(route('teachers.show', $children->class->teacher->id)); ?>" class="text-primary hover:underline">
                                            <?php echo e(__('global.view_teacher_profile')); ?>

                                        </a>
                                    </div>
                                <?php else: ?>
                                    <p class="text-slate-500"><?php echo e(__('global.no_teacher_assigned')); ?></p>
                                <?php endif; ?>
                            </div>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                    <?php echo e(__('global.class_activities')); ?>

                                </h3>
                                <div class="space-y-2 max-h-60 overflow-y-auto">
                                    <?php $__empty_1 = true; $__currentLoopData = $children->class->activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="flex items-center p-2 hover:bg-slate-50 rounded">
                                            <div class="flex-1">
                                            ...
                                            <a href="<?php echo e(route('activities.show', $activity->id)); ?>" class="text-primary hover:underline text-xs">
                                                <?php echo e(__('global.view')); ?>

                                            </a>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <p class="text-slate-500"><?php echo e(__('global.no_activities')); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
                            ...
                            <div class="border rounded-lg p-4">
                                <h3 class="font-medium text-lg mb-3 flex items-center">
                                    <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['icon' => 'CalendarEvent','class' => 'w-5 h-5 me-2 text-primary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.lucide'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'CalendarEvent','class' => 'w-5 h-5 me-2 text-primary']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800)): ?>
<?php $attributes = $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800; ?>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                    <?php echo e(__('global.class_events')); ?>

                                </h3>
                                <div class="space-y-2 max-h-60 overflow-y-auto">
                                    <?php $__empty_1 = true; $__currentLoopData = $children->class->events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $event): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="flex items-center p-2 hover:bg-slate-50 rounded">
                                            <div class="flex-1">
                                                <div class="font-medium text-sm"><?php echo e($event->title ?? $event->name); ?></div>
                                                <div class="text-xs text-slate-500">
                                                    <?php echo e($event->start_datetime ? $event->start_datetime->format('M d, Y') : 'Not scheduled'); ?>

                                                </div>
                                            </div>
                                            <a href="<?php echo e(route('events.show', $event->id)); ?>" class="text-primary hover:underline text-xs">
                                                <?php echo e(__('global.view')); ?>

                                            </a>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <p class="text-slate-500"><?php echo e(__('global.no_events')); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                    <?php echo e(__('global.class_attendance_stats')); ?>

                                </h3>
                                <div class="space-y-3">
                                    <div class="grid grid-cols-3 gap-2">
                                        <div class="text-center p-3 bg-success/10 rounded-lg">
                                            <div class="text-xl font-bold text-success"><?php echo e($children->class->attendances()->where('status', 'present')->count()); ?></div>
                                            <div class="text-xs text-slate-500"><?php echo e(__('global.present')); ?></div>
                                        </div>
                                        <div class="text-center p-3 bg-danger/10 rounded-lg">
                                            <div class="text-xl font-bold text-danger"><?php echo e($children->class->attendances()->where('status', 'absent')->count()); ?></div>
                                            <div class="text-xs text-slate-500"><?php echo e(__('global.absent')); ?></div>
                                        </div>
                                        <div class="text-center p-3 bg-warning/10 rounded-lg">
                                            <div class="text-xl font-bold text-warning"><?php echo e($children->class->attendances()->where('status', 'late')->count()); ?></div>
                                            <div class="text-xs text-slate-500"><?php echo e(__('global.late')); ?></div>
                                        </div>
                                    </div>
                                    <div class="pt-2">
                                        <div class="text-center">
                                            <div class="text-xl font-bold text-primary">
                                                <?php echo e($children->class->attendances()->count() > 0 ? round(($children->class->attendances()->where('status', 'present')->count() / $children->class->attendances()->count()) * 100, 1) : 0); ?>%
                                            </div>
                                            <div class="text-xs text-slate-500"><?php echo e(__('global.attendance_rate')); ?></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\backup\Source\resources\views/pages/children/show.blade.php ENDPATH**/ ?>