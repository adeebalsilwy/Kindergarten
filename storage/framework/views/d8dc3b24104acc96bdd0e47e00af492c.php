<?php $__env->startSection('head'); ?>
    <title>404 - <?php echo e(__('global.page_not_found') ?? 'Page Not Found'); ?></title>
    <style>
    ...
    <div class="error-page-container min-h-screen flex items-center justify-center p-6 dark:bg-darkmode-800">
        <div class="max-w-2xl w-full">
            <div class="intro-y box error-card p-12 text-center rounded-[3rem] shadow-2xl bg-white/80 dark:bg-darkmode-600/80 relative overflow-hidden">
                ...
                <div class="absolute -bottom-24 -left-24 w-64 h-64 bg-warning/5 rounded-full blur-3xl"></div>

                <div class="relative z-10">
                    <!-- Icon -->
                    <div class="floating-icon mb-10 inline-flex items-center justify-center w-32 h-32 rounded-[2.5rem] bg-primary/10 text-primary shadow-inner">
                        <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['icon' => 'MapPinOff','class' => 'w-16 h-16']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'MapPinOff','class' => 'w-16 h-16']); ?>
...
<?php endif; ?>
                    ...
                    <!-- Error Code -->
                    <h1 class="text-9xl font-black text-slate-800 dark:text-slate-200 tracking-tighter mb-4 opacity-10">404</h1>
                    
                    <!-- Message -->
                    <h2 class="text-4xl font-black text-slate-800 dark:text-slate-200 mb-6 tracking-tight">
                        <?php echo e(__('global.oops') ?? 'Oops!'); ?> <?php echo e(__('global.page_not_found') ?? 'Page Not Found'); ?>

                    </h2>
                    <p class="text-slate-500 dark:text-slate-400 text-lg font-bold mb-12 max-w-md mx-auto leading-relaxed">
                        <?php echo e(__('global.404_message') ?? 'The page you are looking for might have been removed, had its name changed, or is temporarily unavailable.'); ?>
...
<?php echo $__env->make('../themes/base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\backup\Source\resources\views/errors/404.blade.php ENDPATH**/ ?>