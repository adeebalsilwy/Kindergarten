...
<?php else: ?>
    <<?php echo e($as); ?>
        ...
        aria-expanded="false"
        <?php echo e($attributes->class(['cursor-pointer'])->merge($attributes->whereDoesntStartWith('class')->getAttributes())); ?>

    ><?php echo e($slot); ?></<?php echo e($as); ?>>
<?php endif; ?>
<?php /**PATH F:\my project\laravel\contract\Source\resources\views/components/base/popover/button.blade.php ENDPATH**/ ?>