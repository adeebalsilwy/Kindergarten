...
<?php endif; ?>
                                    ...
                                    <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('delete_attendances')): ?>
                                        <?php if (isset($component)) { $__componentOriginale00eb601fbe667f0da582732d70c41c5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale00eb601fbe667f0da582732d70c41c5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.button.index','data' => ['variant' => 'outline-danger','size' => 'sm','class' => 'px-2 py-1 delete-btn','dataId' => ''.e($attendance->id).'','dataName' => ''.e($attendance->date->format('Y-m-d')).' - '.e($attendance->child->name ?? '').'','dataDeleteUrl' => ''.e(route('attendances.destroy', $attendance->id)).'','dataTwToggle' => 'modal','dataTwTarget' => '#delete-confirmation-modal']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline-danger','size' => 'sm','class' => 'px-2 py-1 delete-btn','data-id' => ''.e($attendance->id).'','data-name' => ''.e($attendance->date->format('Y-m-d')).' - '.e($attendance->child->name ?? '').'','data-delete-url' => ''.e(route('attendances.destroy', $attendance->id)).'','data-tw-toggle' => 'modal','data-tw-target' => '#delete-confirmation-modal']); ?>
                                            <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
