...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.chart.index','data' => ['class' => 'report-bar-chart','attributes' => $attributes->merge($attributes->whereDoesntStartWith('class')->getAttributes())]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'report-bar-chart','attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes->merge($attributes->whereDoesntStartWith('class')->getAttributes()))]); ?>
...
<?php if (! $__env->hasRenderedOnce('0872337c-e0ca-4da2-b521-f939a9e7751b')): $__env->markAsRenderedOnce('0872337c-e0ca-4da2-b521-f939a9e7751b');
$__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/utils/colors.js'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/components/report-bar-chart.js'); ?>
<?php $__env->stopPush(); endif; ?>
<?php /**PATH F:\my project\laravel\contract\Source\resources\views\components\report-bar-chart\index.blade.php ENDPATH**/ ?>