...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                    <?php echo e(__('global.teacher_details')); ?>
...
<?php endif; ?>
                                    ...
                                    <div class="mt-4 pt-4 border-t">
                                        <div class="grid grid-cols-3 gap-2">
                                            ...
                                            <div class="text-center p-2 bg-purple-50 rounded">
                                                <div class="text-lg font-bold text-purple-600"><?php echo e($classes->children()->count()); ?></div>
...
<?php endif; ?>
                        ...
                        <div class="space-y-4">
                            <div class="flex justify-between py-2 border-b">
                                ...
                                <span class="font-medium"><?php echo e($classes->start_time ? date('H:i', strtotime($classes->start_time)) : __('global.not_specified')); ?></span>
                            </div>
                            <div class="flex justify-between py-2 border-b">
                                <span class="text-slate-500"><?php echo e(__('global.end_time')); ?>:</span>
                                <span class="font-medium"><?php echo e($classes->end_time ? date('H:i', strtotime($classes->end_time)) : __('global.not_specified')); ?></span>
                            </div>
                            <div class="flex justify-between py-2 border-b">
                        ...
                        <div class="space-y-4">
                            <div class="text-center p-4 bg-blue-50 rounded-lg">
                                <div class="text-2xl font-bold text-blue-600">
                                    <?php echo e($classes->start_time && $classes->end_time ? abs(strtotime($classes->end_time) - strtotime($classes->start_time)) / 60 : 0); ?>
                            ...
                            <div class="border rounded-lg p-5">
                                <div class="flex items-start justify-between mb-4">
                                    <div>
                                        ...
                                        <div class="text-slate-500 text-sm mt-1"><?php echo e($classes->curriculum->subject_area ?? 'General'); ?></div>
                                    </div>
                                </div>
                                ...
                                <div class="space-y-4">
                                    <div class="flex justify-between py-2 border-b">
                                        ...
                                        <span class="font-medium"><?php echo e($classes->curriculum->code ?? 'Not specified'); ?></span>
                                    </div>
                                    <div class="flex justify-between py-2 border-b">
                                        <span class="text-slate-500"><?php echo e(__('global.grade_level')); ?>:</span>
                                        <span class="font-medium"><?php echo e($classes->curriculum->grade_level ?? 'Not specified'); ?></span>
                                    </div>
                                    <div class="flex justify-between py-2 border-b">
                                        <span class="text-slate-500"><?php echo e(__('global.duration_weeks')); ?>:</span>
                                        <span class="font-medium"><?php echo e($classes->curriculum->duration_weeks ?? 'N/A'); ?> <?php echo e(__('global.weeks')); ?></span>
                                    </div>
                                    <div class="flex justify-between py-2">
                                        <span class="text-slate-500"><?php echo e(__('global.status')); ?>:</span>
                                        <span class="font-medium px-2 py-1 rounded text-sm 
        ...
        <div id="teacher-details" class="tab-content">
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="intro-y col-span-12">
                    <div class="box p-5">
                        <div class="text-lg font-medium mb-4 flex items-center justify-between">
                            <span><?php echo e(__('global.detailed_teacher_info')); ?></span>
                            <span class="text-sm text-slate-500"><?php echo e($classes->teacher->name); ?></span>
                        </div>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                    <?php echo e(__('global.teacher_classes')); ?>

                                </h3>
                                <div class="space-y-2 max-h-60 overflow-y-auto">
                                    <?php $__empty_1 = true; $__currentLoopData = $classes->teacher->classes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacherClass): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="flex items-center p-2 hover:bg-slate-50 rounded">
                                            <div class="flex-1">
                                                <div class="font-medium text-sm"><?php echo e($teacherClass->name); ?></div>
                                                <div class="text-xs text-slate-500"><?php echo e($teacherClass->age_group ?? 'Not specified'); ?></div>
                                            </div>
                                            <a href="<?php echo e(route('classes.show', $teacherClass->id)); ?>" class="text-primary hover:underline text-xs">
                                                <?php echo e(__('global.view')); ?>

                                            </a>
                                        </div>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                        <p class="text-slate-500"><?php echo e(__('global.no_classes')); ?></p>
                                    <?php endif; ?>
                                </div>
                            </div>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                    <?php echo e(__('global.teacher_activities')); ?>

                                </h3>
                                <div class="space-y-2 max-h-60 overflow-y-auto">
                                    <?php $__empty_1 = true; $__currentLoopData = $classes->teacher->activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacherActivity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="flex items-center p-2 hover:bg-slate-50 rounded">
                                            <div class="flex-1">
                                                <div class="font-medium text-sm"><?php echo e($teacherActivity->title ?? $teacherActivity->name); ?></div>
                                                <div class="text-xs text-slate-500">
                                                    <?php echo e($teacherActivity->scheduled_date ? $teacherActivity->scheduled_date->format('M d, Y') : 'Not scheduled'); ?>

                                                </div>
                                            </div>
                                            <a href="<?php echo e(route('activities.show', $teacherActivity->id)); ?>" class="text-primary hover:underline text-xs">
                                                <?php echo e(__('global.view')); ?>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                    <?php echo e(__('global.teacher_events')); ?>

                                </h3>
                                <div class="space-y-2 max-h-60 overflow-y-auto">
                                    <?php $__empty_1 = true; $__currentLoopData = $classes->teacher->events; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $teacherEvent): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <div class="flex items-center p-2 hover:bg-slate-50 rounded">
                                            <div class="flex-1">
                                                <div class="font-medium text-sm"><?php echo e($teacherEvent->title ?? $teacherEvent->name); ?></div>
                                                <div class="text-xs text-slate-500">
                                                    <?php echo e($teacherEvent->start_datetime ? $teacherEvent->start_datetime->format('M d, Y') : 'Not scheduled'); ?>

                                                </div>
                                            </div>
                                            <a href="<?php echo e(route('events.show', $teacherEvent->id)); ?>" class="text-primary hover:underline text-xs">
                                                <?php echo e(__('global.view')); ?>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                    <?php echo e(__('global.user_account')); ?>

                                </h3>
                                <?php if($classes->teacher->user): ?>
                                    <div class="space-y-2">
                                        <div class="flex justify-between py-2 border-b">
                                            <span class="text-slate-500"><?php echo e(__('global.name')); ?>:</span>
                                            <span class="font-medium"><?php echo e($classes->teacher->user->name); ?></span>
                                        </div>
                                        <div class="flex justify-between py-2 border-b">
                                            <span class="text-slate-500"><?php echo e(__('global.email')); ?>:</span>
                                            <span class="font-medium"><?php echo e($classes->teacher->user->email); ?></span>
                                        </div>
                                        <div class="flex justify-between py-2 border-b">
                                            <span class="text-slate-500"><?php echo e(__('global.status')); ?>:</span>
                                            <span class="font-medium px-2 py-1 rounded text-sm 
                                                <?php echo e($classes->teacher->user->is_active ? 'bg-success/20 text-success' : 'bg-warning/20 text-warning'); ?>">
                                                <?php echo e($classes->teacher->user->is_active ? __('global.active') : __('global.inactive')); ?>

                                            </span>
                                        </div>
                                        <div class="flex justify-between py-2">
                                            <span class="text-slate-500"><?php echo e(__('global.roles')); ?>:</span>
                                            <span class="font-medium"><?php echo e($classes->teacher->user->roles->count()); ?></span>
                                        </div>
                                    </div>
                                    <div class="mt-4">
                                        <a href="<?php echo e(route('users.show', $classes->teacher->user->id)); ?>" class="text-primary hover:underline">
                                            <?php echo e(__('global.view_user_profile')); ?>

                                        </a>
                                    </div>
                                <?php else: ?>
                                    <p class="text-slate-500"><?php echo e(__('global.no_user_account_linked')); ?></p>
                                <?php endif; ?>
                            </div>
                        </div>
                    </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\backup\Source\resources\views\pages\classes\show.blade.php ENDPATH**/ ?>