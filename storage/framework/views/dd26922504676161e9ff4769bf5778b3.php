...
<head>
    ...
    <title><?php echo e(__('test_models.title')); ?> - <?php echo e(config('app.name')); ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p><?php echo e(__('test_models.title')); ?> - <?php echo e(__('global.export_excel')); ?></p>
        </div>
...
</html><?php /**PATH F:\my project\laravel\contract\Source\resources\views\pages\test_models\export-excel.blade.php ENDPATH**/ ?>