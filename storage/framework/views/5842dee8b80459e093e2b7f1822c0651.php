<?php $__env->startSection('subhead'); ?>
    <title><?php echo e(__('access_control.roles.details')); ?> - <?php echo e(config('app.name')); ?></title>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('subcontent'); ?>
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium me-auto"><?php echo e(__('access_control.roles.details')); ?></h2>
    </div>
            ...
            <div class="box p-5">
                <div class="grid grid-cols-12 gap-6">
                    <div class="col-span-12 sm:col-span-6">
                        <div class="text-slate-500 text-xs"><?php echo e(__('access_control.fields.name')); ?></div>
                        <div class="mt-1.5 font-medium text-lg"><?php echo e($role->name); ?></div>
                    </div>
                    <div class="col-span-12 sm:col-span-6 text-end">
                        <div class="text-slate-500 text-xs"><?php echo e(__('access_control.fields.created_at')); ?></div>
                        <div class="mt-1.5 font-medium text-slate-600">
                            <?php echo e($role->created_at->format('Y-m-d H:i')); ?>
...
<?php endif; ?>
                        <?php echo e(__('access_control.fields.permissions')); ?> (<?php echo e($role->permissions->count()); ?>)
                    </div>
...
<?php endif; ?>
                    <?php if (isset($component)) { $__componentOriginale00eb601fbe667f0da582732d70c41c5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale00eb601fbe667f0da582732d70c41c5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.button.index','data' => ['variant' => 'primary','as' => 'a','href' => ''.e(route('roles.edit', $role->id)).'','class' => 'w-32']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'primary','as' => 'a','href' => ''.e(route('roles.edit', $role->id)).'','class' => 'w-32']); ?>
                        <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
...
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\backup\Source\resources\views/pages/access-control/roles/show.blade.php ENDPATH**/ ?>