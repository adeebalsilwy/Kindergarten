...
<?php endif; ?>
                            ...
                            <?php if (isset($component)) { $__componentOriginale00eb601fbe667f0da582732d70c41c5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale00eb601fbe667f0da582732d70c41c5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.button.index','data' => ['variant' => 'outline-danger','dataId' => ''.e($class->id).'','dataName' => ''.e(addslashes($class->name)).'','dataDeleteUrl' => ''.e(route('classes.destroy', $class->id)).'','dataTwToggle' => 'modal','dataTwTarget' => '#delete-confirmation-modal','size' => 'sm','class' => 'px-2 py-1 delete-btn']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['variant' => 'outline-danger','data-id' => ''.e($class->id).'','data-name' => ''.e(addslashes($class->name)).'','data-delete-url' => ''.e(route('classes.destroy', $class->id)).'','data-tw-toggle' => 'modal','data-tw-target' => '#delete-confirmation-modal','size' => 'sm','class' => 'px-2 py-1 delete-btn']); ?>
                                <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
