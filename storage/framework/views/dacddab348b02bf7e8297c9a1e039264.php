...
<head>
    ...
    <title><?php echo e(__('fees.title')); ?> - <?php echo e(config('app.name')); ?></title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p><?php echo e(__('fees.title')); ?> - <?php echo e(__('global.export_excel')); ?></p>
        </div>
...
<?php echo e(tableHeaders); ?>
            ...
            <tbody>
                <?php $__currentLoopData = $<?php echo e('{{variableNamePlural); ?>'}}; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $<?php echo e('fee'); ?>): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
...
</html><?php /**PATH F:\my project\laravel\contract\Source\resources\views\pages\fees\export-excel.blade.php ENDPATH**/ ?>