...
<?php $__env->startSection('subcontent'); ?>
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium me-auto"><?php echo e(__('FinancialReport.show')); ?></h2>
    </div>
...
<?php endif; ?>
                ...
                <div class="flex justify-end mt-5">
                    <a href="<?php echo e(route('financial_reports.index')); ?>" class="btn btn-outline-secondary w-24 me-1"><?php echo e(__('global.back')); ?></a>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\backup\Source\resources\views\pages\financial_reports\show.blade.php ENDPATH**/ ?>