...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['as' => 'a','href' => ''.e(route('logout')).'','onclick' => 'event.preventDefault(); document.getElementById(\'logout-form\').submit();','class' => 'text-red-600 hover:bg-red-50 transition-all duration-200']); ?>
                                <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.button.index','data' => ['as' => 'a','href' => ''.e(route('login')).'','variant' => 'outline-primary','class' => 'transition-all duration-300 hover:scale-105']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['as' => 'a','href' => ''.e(route('login')).'','variant' => 'outline-primary','class' => 'transition-all duration-300 hover:scale-105']); ?>
...
<?php endif; ?>
                        <?php if (isset($component)) { $__componentOriginale00eb601fbe667f0da582732d70c41c5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale00eb601fbe667f0da582732d70c41c5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.button.index','data' => ['as' => 'a','href' => ''.e(route('register')).'','variant' => 'primary','class' => 'transition-all duration-300 hover:scale-105']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['as' => 'a','href' => ''.e(route('register')).'','variant' => 'primary','class' => 'transition-all duration-300 hover:scale-105']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['as' => 'a','href' => ''.e(route('register')).'','variant' => 'primary','class' => 'px-6 py-3 rounded-lg transition-all duration-300 hover:scale-105 hover:shadow-lg']); ?>
                        <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
        ...
        <div class="box p-8 bg-gradient-to-r from-theme-1 to-theme-2 text-white rounded-2xl overflow-hidden">
            ...
            <div class="relative z-10 text-center">
                ...
                <div class="mt-6 flex justify-center gap-3 animate__animated animate__fadeInDown animate__delay-2s">
                    <?php if (isset($component)) { $__componentOriginale00eb601fbe667f0da582732d70c41c5 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginale00eb601fbe667f0da582732d70c41c5 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.button.index','data' => ['as' => 'a','href' => ''.e(route('register')).'','class' => 'bg-white text-primary hover:bg-slate-100 px-8 py-3 rounded-lg transition-all duration-300 hover:scale-105','variant' => 'secondary']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.button'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['as' => 'a','href' => ''.e(route('register')).'','class' => 'bg-white text-primary hover:bg-slate-100 px-8 py-3 rounded-lg transition-all duration-300 hover:scale-105','variant' => 'secondary']); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['as' => 'a','href' => ''.e(route('login')).'','variant' => 'outline-secondary','class' => 'border-white text-white hover:bg-white hover:text-theme-1 px-8 py-3 rounded-lg transition-all duration-300 hover:scale-105']); ?>
                        <?php echo e(__('global.sign_in')); ?>
            ...
            <div class="grid grid-cols-12 gap-6">
                ...
                <div class="col-span-12 md:col-span-4">
                    ...
                    <ul class="mt-3 space-y-2 text-slate-600">
                        ...
                        <?php else: ?>
                            <li><a class="hover:text-primary transition-all duration-300" href="<?php echo e(route('login')); ?>"><?php echo e(__('global.sign_in')); ?></a></li>
                            <li><a class="hover:text-primary transition-all duration-300" href="<?php echo e(route('register')); ?>"><?php echo e(__('global.get_started')); ?></a></li>
                        <?php endif; ?>
                    </ul>
                </div>
                <div class="col-span-12 md:col-span-4">
...
<?php if (! $__env->hasRenderedOnce('dac5c775-d72a-4a25-a85c-21a0cfde0452')): $__env->markAsRenderedOnce('dac5c775-d72a-4a25-a85c-21a0cfde0452');
...
<?php if (! $__env->hasRenderedOnce('7173285c-7d3f-478b-8ae3-238599e48f28')): $__env->markAsRenderedOnce('7173285c-7d3f-478b-8ae3-238599e48f28');
...
<?php if (! $__env->hasRenderedOnce('4a27cc46-9f0d-4d76-aea1-bd8f33ed403d')): $__env->markAsRenderedOnce('4a27cc46-9f0d-4d76-aea1-bd8f33ed403d');
$__env->startPush('scripts'); ?>
    <script>
        document.addEventListener('DOMContentLoaded', function () {
...
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\backup\Source\resources\views/pages/landing.blade.php ENDPATH**/ ?>