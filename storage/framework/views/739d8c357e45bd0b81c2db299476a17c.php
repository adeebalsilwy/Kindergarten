...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.chart.index','data' => ['class' => 'report-donut-chart-2','attributes' => $attributes->merge($attributes->whereDoesntStartWith('class')->getAttributes())]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'report-donut-chart-2','attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes->merge($attributes->whereDoesntStartWith('class')->getAttributes()))]); ?>
...
<?php if (! $__env->hasRenderedOnce('b1a85c21-f60a-4d78-a338-238154c25f08')): $__env->markAsRenderedOnce('b1a85c21-f60a-4d78-a338-238154c25f08');
$__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/utils/colors.js'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/components/report-donut-chart-2.js'); ?>
<?php $__env->stopPush(); endif; ?>
<?php /**PATH F:\my project\laravel\contract\Source\resources\views\components\report-donut-chart-2\index.blade.php ENDPATH**/ ?>