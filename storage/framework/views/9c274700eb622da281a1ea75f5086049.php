            ...
            <div class="my-10 flex h-screen py-5 xl:my-0 xl:h-auto xl:py-0">
                <div class="mx-auto my-auto w-full rounded-md bg-white px-5 py-8 shadow-md dark:bg-darkmode-600 sm:w-3/4 sm:px-8 lg:w-2/4 xl:w-auto xl:bg-transparent xl:p-0 xl:shadow-none">
                    ...
                    <div class="mt-2 text-center text-slate-400 xl:text-left">
                        <?php echo e(__('global.email_reset_instructions')); ?>
                    ...
                    <?php endif; ?>
                    <form method="POST" action="<?php echo e(route('password.email')); ?>" class="mt-6">
                        <?php echo csrf_field(); ?>
                        <?php if (isset($component)) { $__componentOriginal40054831fd8fc1521987609af4b37cc0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal40054831fd8fc1521987609af4b37cc0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-input.index','data' => ['class' => 'block min-w-full px-4 py-3 xl:min-w-[350px]','type' => 'email','name' => 'email','placeholder' => ''.e(__('global.email')).'','value' => ''.e(old('email')).'','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'block min-w-full px-4 py-3 xl:min-w-[350px]','type' => 'email','name' => 'email','placeholder' => ''.e(__('global.email')).'','value' => ''.e(old('email')).'','required' => true]); ?>
...
<?php $component->withAttributes(['class' => 'w-full px-4 py-3 xl:w-40','variant' => 'primary','type' => 'submit']); ?>
                                <?php echo e(__('global.send_reset_link')); ?>
...
<?php echo $__env->make('../themes/base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\my project\laravel\contract\Source\resources\views\pages\passwords\forgot.blade.php ENDPATH**/ ?>