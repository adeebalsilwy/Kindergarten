    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-10">
            <div class="intro-y box p-5">
                <form action="<?php echo e(route('caches.update', $cache->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('caches.fields.name')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-input.index','data' => ['type' => 'text','name' => 'name','value' => ''.e(old('name', $cache->name ?? '')).'','class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'name','value' => ''.e(old('name', $cache->name ?? '')).'','class' => 'mt-2']); ?>
...
<?php endif; ?>
                    ...
                    <div class="flex justify-end mt-5">
                        <a href="<?php echo e(route('caches.index')); ?>" class="btn btn-outline-secondary w-24 mr-1"><?php echo e(__('global.cancel')); ?></a>
...
<?php echo $__env->make('../themes/kindergarten', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\my project\laravel\contract\Source\resources\views\pages\caches\edit.blade.php ENDPATH**/ ?>