...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-input.index','data' => ['class' => 'intro-x block min-w-full px-4 py-3 xl:min-w-[400px] border-slate-300 focus:border-primary focus:ring-primary','type' => 'email','name' => 'email','id' => 'email','placeholder' => ''.e(__('global.enter_your_email')).'','value' => ''.e(old('email')).'','autocomplete' => 'email']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'intro-x block min-w-full px-4 py-3 xl:min-w-[400px] border-slate-300 focus:border-primary focus:ring-primary','type' => 'email','name' => 'email','id' => 'email','placeholder' => ''.e(__('global.enter_your_email')).'','value' => ''.e(old('email')).'','autocomplete' => 'email']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                    <div class="relative">
                                        <?php if (isset($component)) { $__componentOriginal40054831fd8fc1521987609af4b37cc0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal40054831fd8fc1521987609af4b37cc0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-input.index','data' => ['class' => 'intro-x block min-w-full px-4 py-3 xl:min-w-[400px] border-slate-300 focus:border-primary focus:ring-primary pe-12','type' => 'password','name' => 'password','id' => 'password','placeholder' => ''.e(__('global.enter_your_password')).'','autocomplete' => 'current-password']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.form-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'intro-x block min-w-full px-4 py-3 xl:min-w-[400px] border-slate-300 focus:border-primary focus:ring-primary pe-12','type' => 'password','name' => 'password','id' => 'password','placeholder' => ''.e(__('global.enter_your_password')).'','autocomplete' => 'current-password']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal40054831fd8fc1521987609af4b37cc0)): ?>
<?php $attributes = $__attributesOriginal40054831fd8fc1521987609af4b37cc0; ?>
...
<?php endif; ?>
                                                        <div>
                                                            <div class="text-xs font-bold text-slate-700 dark:text-slate-300 group-hover:text-white truncate">
                                                                <?php echo e($acc['name'] ?? __($acc['role_key'])); ?>
...
<?php if (! $__env->hasRenderedOnce('71c35b72-d673-45c6-afec-07d179991f95')): $__env->markAsRenderedOnce('71c35b72-d673-45c6-afec-07d179991f95');
...
<?php echo $__env->make('../themes/base', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\backup\Source\resources\views/pages/login.blade.php ENDPATH**/ ?>