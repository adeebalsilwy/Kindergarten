...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.chart.index','data' => ['id' => 'report-donut-chart','attributes' => $attributes->merge($attributes->whereDoesntStartWith('class')->getAttributes())]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['id' => 'report-donut-chart','attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes->merge($attributes->whereDoesntStartWith('class')->getAttributes()))]); ?>
...
<?php if (! $__env->hasRenderedOnce('ef1c3454-7fb4-4238-a4c4-253bd2cd742d')): $__env->markAsRenderedOnce('ef1c3454-7fb4-4238-a4c4-253bd2cd742d');
$__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/utils/colors.js'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/components/report-donut-chart.js'); ?>
<?php $__env->stopPush(); endif; ?>
<?php /**PATH F:\my project\laravel\contract\Source\resources\views\components\report-donut-chart\index.blade.php ENDPATH**/ ?>