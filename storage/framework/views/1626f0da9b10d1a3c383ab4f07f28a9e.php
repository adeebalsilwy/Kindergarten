    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-10">
            <div class="intro-y box p-5">
                <form action="<?php echo e(route('financial-reports.store')); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php endif; ?>
                    ...
                    <div class="flex justify-end mt-5">
                        <a href="<?php echo e(route('financial-reports.index')); ?>" class="btn btn-outline-secondary w-24 me-1"><?php echo e(__('global.cancel')); ?></a>
...
<?php echo $__env->make('../themes/kindergarten', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\backup\Source\resources\views\pages\financial-reports\create.blade.php ENDPATH**/ ?>