...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['class' => 'h-8 w-8 text-'.e($color).'','icon' => ''.e($icon).'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'h-8 w-8 text-'.e($color).'','icon' => ''.e($icon).'']); ?>
...
<?php endif; ?> 
            ...
            <div class="mt-6 text-2xl font-medium leading-8 text-slate-600 dark:text-slate-300">
                <?php if($format === 'currency'): ?>
                    <?php echo e(__('global.currency_symbol', ['amount' => number_format($value)])); ?>
            ...
            <div class="mt-1 text-base text-slate-500"><?php echo e($title); ?></div>
            <?php if($description): ?>
                <div class="mt-1 text-sm text-slate-400"><?php echo e($description); ?></div>
            <?php endif; ?>
        </div>
    </div>
</div><?php /**PATH F:\my project\laravel\contract\Source\resources\views/components/widgets/stat-card.blade.php ENDPATH**/ ?>