<?php if(session('success') || session('error') || session('warning') || session('info')): ?>
    <?php if (! $__env->hasRenderedOnce('76b3f702-ecd3-4819-8a60-449a1b33d283')): $__env->markAsRenderedOnce('76b3f702-ecd3-4819-8a60-449a1b33d283');
$__env->startPush('styles'); ?>
        <?php echo app('Illuminate\Foundation\Vite')('resources/css/vendors/toastify.css'); ?>
    <?php $__env->stopPush(); endif; ?>

    <?php if (! $__env->hasRenderedOnce('38b55a74-784a-4659-aa4f-f3be18799686')): $__env->markAsRenderedOnce('38b55a74-784a-4659-aa4f-f3be18799686');
