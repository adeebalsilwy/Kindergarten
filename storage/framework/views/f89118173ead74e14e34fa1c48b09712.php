...
<div class="intro-y col-span-12">
    <div class="box p-5 bg-slate-50">
        <form action="<?php echo e($action); ?>" method="<?php echo e($method); ?>">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-<?php echo e($cols); ?> gap-4 mb-4">
                <?php echo e($slot); ?>

            </div>

            <div class="flex items-center justify-end gap-2 pt-4 border-t border-slate-200">
                <?php if($showReset && $resetRoute): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['icon' => 'RotateCcw','class' => 'w-4 h-4 inline me-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'RotateCcw','class' => 'w-4 h-4 inline me-1']); ?>
...
<?php endif; ?>
                        <?php echo e(__('global.reset_filters')); ?>
...
<?php /**PATH E:\backup\Source\resources\views/components/filter-bar.blade.php ENDPATH**/ ?>