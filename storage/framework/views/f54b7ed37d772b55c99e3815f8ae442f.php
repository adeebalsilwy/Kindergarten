...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.chart.index','data' => ['class' => 'line-chart','attributes' => $attributes->merge($attributes->whereDoesntStartWith('class')->getAttributes())]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'line-chart','attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes->merge($attributes->whereDoesntStartWith('class')->getAttributes()))]); ?>
...
<?php if (! $__env->hasRenderedOnce('8fa5ce6e-e04e-4366-bb4e-bc624c77b5c7')): $__env->markAsRenderedOnce('8fa5ce6e-e04e-4366-bb4e-bc624c77b5c7');
...
<?php /**PATH F:\my project\laravel\contract\Source\resources\views\components\line-chart\index.blade.php ENDPATH**/ ?>