...
<head>
    <meta charset="utf-8">
    <title><?php echo e(__('Classes.title')); ?></title>
    <style>
        body {
...
<body>
    <div class="header">
        <div class="title"><?php echo e(__('Classes.title')); ?></div>
                ...
                <?php if(count($data) > 0): ?>
                    <?php $__currentLoopData = $data[0]->getAttributes(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php if(!in_array($key, ['id', 'created_at', 'updated_at', 'deleted_at'])): ?>
                            <th><?php echo e(__('Classes.fields.'.$key)); ?></th>
                        <?php endif; ?>
...
</html><?php /**PATH F:\my project\laravel\contract\Source\resources\views\pages\classes\export-pdf.blade.php ENDPATH**/ ?>