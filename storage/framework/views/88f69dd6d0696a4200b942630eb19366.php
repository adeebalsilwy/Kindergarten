...
<div class="intro-y flex items-center mt-8">
    <h2 class="text-lg font-medium me-auto"><?php echo e(__('global.add_dashboard_content')); ?></h2>
</div>
    ...
    <div class="intro-y col-span-12 lg:col-span-8 mx-auto">
        <div class="tab-content mt-5">
            <div class="tab-pane active" id="content-form">
                <div class="box p-5">
                    <form method="POST" action="<?php echo e(route('dashboard-content.store')); ?>">
                        <?php echo csrf_field(); ?>
...
<?php $component->withAttributes(['id' => 'section','name' => 'section','class' => 'form-control @error(\'section\') is-invalid @enderror','required' => true]); ?>
                                    ...
                                    <option value="welcome_section" <?php echo e(old('section') == 'welcome_section' ? 'selected' : ''); ?>>Welcome Section</option>
                                    <option value="stats_cards" <?php echo e(old('section') == 'stats_cards' ? 'selected' : ''); ?>>Stats Cards</option>
                                    <option value="recent_activities" <?php echo e(old('section') == 'recent_activities' ? 'selected' : ''); ?>>Recent Activities</option>
                                    <option value="monthly_summary" <?php echo e(old('section') == 'monthly_summary' ? 'selected' : ''); ?>>Monthly Summary</option>
                                    <option value="quick_actions" <?php echo e(old('section') == 'quick_actions' ? 'selected' : ''); ?>>Quick Actions</option>
                                    <option value="parents_communication" <?php echo e(old('section') == 'parents_communication' ? 'selected' : ''); ?>>Parents Communication</option>
                                    <option value="important_updates" <?php echo e(old('section') == 'important_updates' ? 'selected' : ''); ?>>Important Updates</option>
                                    <option value="custom" <?php echo e(old('section') == 'custom' ? 'selected' : ''); ?>>Custom Section</option>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-input.index','data' => ['id' => 'key','name' => 'key','type' => 'text','class' => 'form-control @error(\'key\') is-invalid @enderror','placeholder' => ''.e(__('global.enter_key')).'','value' => ''.e(old('key')).'','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'key','name' => 'key','type' => 'text','class' => 'form-control @error(\'key\') is-invalid @enderror','placeholder' => ''.e(__('global.enter_key')).'','value' => ''.e(old('key')).'','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'content_en','name' => 'content_en','class' => 'form-control @error(\'content_en\') is-invalid @enderror','placeholder' => ''.e(__('global.enter_content_en')).'','rows' => '4','required' => true]); ?><?php echo e(old('content_en')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'content_ar','name' => 'content_ar','class' => 'form-control @error(\'content_ar\') is-invalid @enderror','placeholder' => ''.e(__('global.enter_content_ar')).'','rows' => '4','required' => true]); ?><?php echo e(old('content_ar')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal29dbcf960a4ade6d0a2b790c04ae12cf)): ?>
<?php $attributes = $__attributesOriginal29dbcf960a4ade6d0a2b790c04ae12cf; ?>
<?php unset($__attributesOriginal29dbcf960a4ade6d0a2b790c04ae12cf); ?>
...
unset($__errorArgs, $__bag); ?>" 
                                    type="checkbox" value="1" <?php echo e(old('is_active', 1) ? 'checked' : ''); ?> />
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['id' => 'order','name' => 'order','type' => 'number','class' => 'form-control @error(\'order\') is-invalid @enderror','placeholder' => ''.e(__('global.enter_order')).'','value' => ''.e(old('order', 0)).'','min' => '0']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal40054831fd8fc1521987609af4b37cc0)): ?>
<?php $attributes = $__attributesOriginal40054831fd8fc1521987609af4b37cc0; ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mt-5">
                            <a href="<?php echo e(route('dashboard-content.index')); ?>" class="btn btn-outline-secondary w-24 me-1"><?php echo e(__('global.cancel')); ?></a>
                            <button type="submit" class="btn btn-primary w-24"><?php echo e(__('global.save')); ?></button>
                        </div>
                    </form>
                </div>
            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH E:\backup\Source\resources\views\pages\dashboard-content\create.blade.php ENDPATH**/ ?>