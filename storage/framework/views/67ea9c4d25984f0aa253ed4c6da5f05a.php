...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.chart.index','data' => ['class' => 'donut-chart','attributes' => $attributes->merge($attributes->whereDoesntStartWith('class')->getAttributes())]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => 'donut-chart','attributes' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($attributes->merge($attributes->whereDoesntStartWith('class')->getAttributes()))]); ?>
...
<?php if (! $__env->hasRenderedOnce('aebc4f8f-c65f-4716-a5a4-3af25547566e')): $__env->markAsRenderedOnce('aebc4f8f-c65f-4716-a5a4-3af25547566e');
$__env->startPush('scripts'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/utils/colors.js'); ?>
    <?php echo app('Illuminate\Foundation\Vite')('resources/js/components/donut-chart.js'); ?>
<?php $__env->stopPush(); endif; ?>
<?php /**PATH F:\my project\laravel\contract\Source\resources\views\components\donut-chart\index.blade.php ENDPATH**/ ?>