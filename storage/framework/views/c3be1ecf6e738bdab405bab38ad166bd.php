...
<?php $__env->startSection('head'); ?>
    <title><?php echo e(__('global.create_permission')); ?> - <?php echo e(config('app.name')); ?></title>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('subcontent'); ?>
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"><?php echo e(__('global.create_new_permission')); ?></h2>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-input.index','data' => ['type' => 'text','name' => 'name','value' => ''.e(old('name')).'','class' => 'mt-2','placeholder' => ''.e(__('global.enter_permission_name')).'','required' => true]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'name','value' => ''.e(old('name')).'','class' => 'mt-2','placeholder' => ''.e(__('global.enter_permission_name')).'','required' => true]); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                                <select name="guard_name" class="form-select mt-2">
                                    <option value="web" <?php echo e(old('guard_name', 'web') == 'web' ? 'selected' : ''); ?>>web</option>
                                    <option value="api" <?php echo e(old('guard_name') == 'api' ? 'selected' : ''); ?>>api</option>
                                </select>
                                <div class="text-slate-500 text-xs mt-1"><?php echo e(__('global.guard_name_explanation')); ?></div>
                            </div>
                        </div>
                    </div>
...
<?php endif; ?>
                            ...
                            <h3 class="text-lg font-medium"><?php echo e(__('global.preview')); ?></h3>
                        </div>
                        
                        <div class="p-4 bg-slate-50 dark:bg-darkmode-600 rounded-lg">
                            <div class="text-center">
                                <div class="text-sm text-slate-600 dark:text-slate-400 mb-2"><?php echo e(__('global.permission_display_name')); ?></div>
                                <div id="permissionPreview" class="text-lg font-medium text-slate-800 dark:text-slate-200">
                                    <?php echo e(old('name') ? str_replace('_', ' ', old('name')) : __('global.enter_name_to_preview')); ?>

                                </div>
                                <div class="mt-2 text-xs text-slate-500">
                                    <?php echo e(__('global.this_is_how_it_will_appear')); ?>
...
<?php endif; ?>
                            ...
                            <h3 class="text-lg font-medium"><?php echo e(__('global.automatic_assignment')); ?></h3>
                        </div>
                        ...
                        <div class="p-4 bg-info/10 border border-info/20 rounded-lg">
                            <div class="flex items-start">
                                <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['icon' => 'Info','class' => 'w-5 h-5 text-info mt-0.5 mr-3 flex-shrink-0']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.lucide'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'Info','class' => 'w-5 h-5 text-info mt-0.5 mr-3 flex-shrink-0']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800)): ?>
<?php $attributes = $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800; ?>
...
<?php endif; ?>
                                <div>
                                    <p class="text-info font-medium"><?php echo e(__('global.admin_auto_assignment_notice')); ?></p>
                                    <p class="text-sm text-info mt-1"><?php echo e(__('global.permission_will_be_assigned_to_admin')); ?></p>
                                    <div class="mt-2 flex items-center text-xs text-info">
                                        <?php if (isset($component)) { $__componentOriginal16b2e62e74cde9150905c2d0c2cb6800 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.lucide.index','data' => ['icon' => 'Crown','class' => 'w-4 h-4 mr-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.lucide'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['icon' => 'Crown','class' => 'w-4 h-4 mr-1']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800)): ?>
<?php $attributes = $__attributesOriginal16b2e62e74cde9150905c2d0c2cb6800; ?>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                        <?php echo e(__('global.admin_role')); ?> (ID: 1)
                                    </div>
                                </div>
                            </div>
                        </div>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                                <?php echo e(__('global.create_permission')); ?>
...
<?php unset($__componentOriginal16b2e62e74cde9150905c2d0c2cb6800); ?>
<?php endif; ?>
                    <?php echo e(__('global.creation_guide')); ?>
                ...
                <div class="space-y-4 text-sm text-slate-600 dark:text-slate-400">
                    <div class="flex items-start">
                        ...
                        <div>
                            <strong class="text-slate-800 dark:text-slate-200"><?php echo e(__('global.naming_convention')); ?></strong>
                            <p class="mt-1"><?php echo e(__('global.use_underscore_separation')); ?></p>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <strong class="text-slate-800 dark:text-slate-200"><?php echo e(__('global.guard_selection')); ?></strong>
                            <p class="mt-1"><?php echo e(__('global.choose_appropriate_guard')); ?></p>
                            <ul class="mt-1 text-xs space-y-1">
                                <li>• <strong>web</strong>: <?php echo e(__('global.web_interface_access')); ?></li>
                                <li>• <strong>api</strong>: <?php echo e(__('global.api_endpoint_access')); ?></li>
                            </ul>
                        </div>
                    </div>
                    ...
                    <div class="flex items-start">
                        ...
                        <div>
                            <strong class="text-slate-800 dark:text-slate-200"><?php echo e(__('global.immediate_assignment')); ?></strong>
                            <p class="mt-1"><?php echo e(__('global.new_permission_auto_assigned')); ?></p>
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function(e) {
            ...
            if (!/^[a-z_]+$/.test(name)) {
                if (!confirm('<?php echo e(__('global.naming_convention_warning')); ?>')) {
                    e.preventDefault();
                    return;
                }
            }
...
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\my project\laravel\contract\Source\resources\views\pages\permissions\create.blade.php ENDPATH**/ ?>