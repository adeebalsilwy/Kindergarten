...
<?php $__env->startSection('head'); ?>
    <title><?php echo e(__('Report.add_new')); ?> - Laravel</title>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('subcontent'); ?>
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"><?php echo e(__('Report.add_new')); ?></h2>
    </div>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('reports.fields.name')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-input.index','data' => ['type' => 'text','name' => 'name','value' => ''.e(old('name', $report->name ?? '')).'','class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'name','value' => ''.e(old('name', $report->name ?? '')).'','class' => 'mt-2']); ?>
...
<?php endif; ?>
                    ...
                    <div class="flex justify-end mt-5">
                        <a href="<?php echo e(route('reports.index')); ?>" class="btn btn-outline-secondary w-24 mr-1"><?php echo e(__('global.cancel')); ?></a>
...
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH F:\my project\laravel\contract\Source\resources\views\pages\reports\create.blade.php ENDPATH**/ ?>