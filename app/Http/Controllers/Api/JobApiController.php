...
class JobApiController extends BaseApiController
{
    ...
    public function store(StoreJobRequest $request): JsonResponse
    {
        ...
        return $this->sendResponse(new JobResource($job), __('jobs.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new JobResource($job), __('jobs.messages.retrieved'));
    }
    ...
    public function update(UpdateJobRequest $request, $id): JsonResponse
    {
        ...
        return $this->sendResponse(new JobResource($job), __('jobs.messages.updated'));
    }
