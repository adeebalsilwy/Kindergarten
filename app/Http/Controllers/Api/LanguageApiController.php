...
class LanguageApiController extends BaseApiController
{
    ...
    public function store(StoreLanguageRequest $request): JsonResponse
    {
        ...
        return $this->sendResponse(new LanguageResource($language), __('languages.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new LanguageResource($language), __('languages.messages.retrieved'));
    }
    ...
    {
        $language = $this->service->update($id, $request->validated());

        return $this->sendResponse(new LanguageResource($language), __('languages.messages.updated'));
    }
