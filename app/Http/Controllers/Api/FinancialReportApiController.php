...
class FinancialReportApiController extends BaseApiController
{
    ...
    {
        $financialReport = $this->service->create($request->validated());

        return $this->sendResponse(new FinancialReportResource($financialReport), __('financial_reports.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new FinancialReportResource($financialReport), __('financial_reports.messages.retrieved'));
    }
    ...
    {
        $financialReport = $this->service->update($id, $request->validated());

        return $this->sendResponse(new FinancialReportResource($financialReport), __('financial_reports.messages.updated'));
    }
