...
class GradeApiController extends BaseApiController
{
    ...
    public function store(StoreGradeRequest $request): JsonResponse
    {
        ...
        return $this->sendResponse(new GradeResource($grade), __('grades.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new GradeResource($grade), __('grades.messages.retrieved'));
    }
    ...
    public function update(UpdateGradeRequest $request, $id): JsonResponse
    {
        ...
        return $this->sendResponse(new GradeResource($grade), __('grades.messages.updated'));
    }
