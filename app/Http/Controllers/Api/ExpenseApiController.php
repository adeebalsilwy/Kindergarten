...
class ExpenseApiController extends BaseApiController
{
    ...
    public function store(StoreExpenseRequest $request): JsonResponse
    {
        ...
        return $this->sendResponse(new ExpenseResource($expense), __('expenses.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new ExpenseResource($expense), __('expenses.messages.retrieved'));
    }
    ...
    public function update(UpdateExpenseRequest $request, $id): JsonResponse
    {
        ...
        return $this->sendResponse(new ExpenseResource($expense), __('expenses.messages.updated'));
    }
