...
class AccountingEntryApiController extends BaseApiController
{
    ...
    {
        $accountingEntry = $this->service->create($request->validated());

        return $this->sendResponse(new AccountingEntryResource($accountingEntry), __('accounting_entries.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new AccountingEntryResource($accountingEntry), __('accounting_entries.messages.retrieved'));
    }
    ...
    {
        $accountingEntry = $this->service->update($id, $request->validated());

        return $this->sendResponse(new AccountingEntryResource($accountingEntry), __('accounting_entries.messages.updated'));
    }
