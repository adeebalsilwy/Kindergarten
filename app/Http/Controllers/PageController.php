...
class PageController extends Controller
{
    ...
    public function __construct(FinancialReportService $financialReportService, DashboardService $dashboardService)
    {
    ...
    public function dashboardOverview1(): View
    {
        ...
        $enhancedMetrics = $this->dashboardService->getGeneralMetrics();
        $attendanceStats = $this->dashboardService->getAttendanceStats();
        $financialStats = $this->dashboardService->getFinancialStats();
        $enrollmentStats = $this->dashboardService->getEnrollmentStats();
        $classStats = $this->dashboardService->getClassStats();
        $academicStats = $this->dashboardService->getAcademicStats();
        ...
        // Prepare stats for backward compatibility
        $stats = [
            'total_students' => $enhancedMetrics['total_students'],
            'total_teachers' => $enhancedMetrics['total_teachers'],
            'total_classes' => $enhancedMetrics['total_classes'],
            'active_attendance' => $enhancedMetrics['active_attendance'],
        ];
    ...
    public function login(): View
    {
        $demoAccounts = [
            [
                ...
                'password' => 'admin123',
                'role_key' => 'global.administrator',
            ],
            [
                'email' => 'principal@kindergarten.ye',
                'password' => 'principal123',
                'role_key' => 'global.principal',
            ],
            [
                'email' => 'teacher@kindergarten.ye',
                'password' => 'teacher123',
                'role_key' => 'global.teacher',
            ],
            [
                'email' => 'parent@kindergarten.ye',
                'password' => 'parent123',
                'role_key' => 'global.parent_user',
            ],
            [
                'email' => 'accountant@kindergarten.ye',
                'password' => 'accountant123',
                'role_key' => 'global.accountant',
            ],
        ];
