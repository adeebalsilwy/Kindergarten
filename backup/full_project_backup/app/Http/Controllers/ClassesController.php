...
class ClassesController extends Controller
{
    ...
    protected function exportToExcel($data)
    {
        ...
        // Set the title
        $sheet->setTitle(__('kindergarten.classes.title'));
        $sheet->setCellValue('A1', __('kindergarten.classes.title'));
        ...
        if ($data->count() > 0) {
            ...
            foreach ($firstItem->getAttributes() as $key => $value) {
                if (! in_array($key, ['id', 'created_at', 'updated_at', 'deleted_at'])) {
                    $headers[] = __('kindergarten.classes.'.$key);
                }
            }
        }
    ...
    public function create()
    {
        ...
        return view('pages.classes.create', get_defined_vars());
    }
    ...
    public function store(StoreClassesRequest $request)
    {
        ...
        return redirect()->route('classes.index')->with('success', __('kindergarten.messages.created'));
    }

    public function show($id)
    {
        $this->authorize('view_classes');
        $classes = \App\Models\Classes::with(['teacher', 'students.parent'])->findOrFail($id);
    ...
    public function edit($id)
    {
        ...
        return view('pages.classes.edit', get_defined_vars());
    }
    ...
    public function update(UpdateClassesRequest $request, $id)
    {
        ...
        return redirect()->route('classes.index')->with('success', __('kindergarten.messages.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('classes.index')->with('success', __('kindergarten.messages.deleted'));
    }
}
