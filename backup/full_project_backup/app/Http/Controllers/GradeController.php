...
class GradeController extends Controller
{
    ...
    protected function exportToExcel($data)
    {
        ...
        // Set the title
        $sheet->setTitle(__('kindergarten.grades.title'));
        $sheet->setCellValue('A1', __('kindergarten.grades.title'));
        ...
        if ($data->count() > 0) {
            ...
            foreach ($firstItem->getAttributes() as $key => $value) {
                if (! in_array($key, ['id', 'created_at', 'updated_at', 'deleted_at'])) {
                    $headers[] = __('kindergarten.grades.'.$key);
                }
            }
        }
    ...
    public function store(StoreGradeRequest $request)
    {
        ...
        return redirect()->route('grades.index')->with('success', __('kindergarten.messages.created'));
    }
    ...
    public function show($id)
    {
        ...
        return view('pages.grades.show', compact('grades'));
    }
    ...
    public function update(UpdateGradeRequest $request, $id)
    {
        ...
        return redirect()->route('grades.index')->with('success', __('kindergarten.messages.updated'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('grades.index')->with('success', __('kindergarten.messages.deleted'));
    }
}
