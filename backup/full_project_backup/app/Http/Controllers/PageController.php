...
class PageController extends Controller
{
    ...
    public function __construct(\App\Services\Finance\FinancialReportService $financialReportService)
    {
    ...
    public function dashboardOverview1(): View
    {
        ...
        return view('pages/dashboard-overview-1', compact('currentMonth', 'outstandingBalances', 'stats'));
    }
