...
class CommandLogApiController extends BaseApiController
{
    ...
    {
        $commandLogs = $this->service->create($request->validated());

        return $this->sendResponse(new CommandLogResource($commandLogs), __('command_logs.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new CommandLogResource($commandLogs), __('command_logs.messages.retrieved'));
    }
    ...
    {
        $commandLogs = $this->service->update($id, $request->validated());

        return $this->sendResponse(new CommandLogResource($commandLogs), __('command_logs.messages.updated'));
    }
