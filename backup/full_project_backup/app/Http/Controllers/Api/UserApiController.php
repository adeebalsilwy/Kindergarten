...
class UserApiController extends BaseApiController
{
    ...
    {
        $users = $this->service->create($request->validated());

        return $this->sendResponse(new UserResource($users), __('users.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new UserResource($users), __('users.messages.retrieved'));
    }
    ...
    public function update(UpdateUserRequest $request, $id): JsonResponse
    {
        ...
        return $this->sendResponse(new UserResource($users), __('users.messages.updated'));
    }
