...
class PaymentApiController extends BaseApiController
{
    ...
    {
        $payments = $this->service->create($request->validated());

        return $this->sendResponse(new PaymentResource($payments), __('payments.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new PaymentResource($payments), __('payments.messages.retrieved'));
    }
    ...
    {
        $payments = $this->service->update($id, $request->validated());

        return $this->sendResponse(new PaymentResource($payments), __('payments.messages.updated'));
    }
