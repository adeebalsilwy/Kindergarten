...
class AttendanceApiController extends BaseApiController
{
    ...
    {
        $attendances = $this->service->create($request->validated());

        return $this->sendResponse(new AttendanceResource($attendances), __('attendances.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new AttendanceResource($attendances), __('attendances.messages.retrieved'));
    }
    ...
    {
        $attendances = $this->service->update($id, $request->validated());

        return $this->sendResponse(new AttendanceResource($attendances), __('attendances.messages.updated'));
    }
