...
class FeeApiController extends BaseApiController
{
    ...
    {
        $fees = $this->service->create($request->validated());

        return $this->sendResponse(new FeeResource($fees), __('fees.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new FeeResource($fees), __('fees.messages.retrieved'));
    }
    ...
    {
        $fees = $this->service->update($id, $request->validated());

        return $this->sendResponse(new FeeResource($fees), __('fees.messages.updated'));
    }
