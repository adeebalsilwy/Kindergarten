...
class TeacherApiController extends BaseApiController
{
    ...
    {
        $teachers = $this->service->create($request->validated());

        return $this->sendResponse(new TeacherResource($teachers), __('teachers.messages.created'), 201);
    }
    ...
    public function show($id): JsonResponse
    {
        ...
        return $this->sendResponse(new TeacherResource($teachers), __('teachers.messages.retrieved'));
    }
    ...
    {
        $teachers = $this->service->update($id, $request->validated());

        return $this->sendResponse(new TeacherResource($teachers), __('teachers.messages.updated'));
    }
