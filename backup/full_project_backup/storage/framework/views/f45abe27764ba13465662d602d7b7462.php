    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        <div class="intro-y col-span-12 lg:col-span-10">
            <div class="intro-y box p-5">
                <form action="<?php echo e(route('attendances.update', $attendances->id)); ?>" method="POST" enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-input.index','data' => ['type' => 'text','name' => 'child_id','value' => ''.e(old('child_id', $attendances->child_id ?? '')).'','class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'text','name' => 'child_id','value' => ''.e(old('child_id', $attendances->child_id ?? '')).'','class' => 'mt-2']); ?>
...
<?php endif; ?>
                            <?php if (isset($component)) { $__componentOriginal40054831fd8fc1521987609af4b37cc0 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginal40054831fd8fc1521987609af4b37cc0 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.form-input.index','data' => ['type' => 'date','name' => 'date','value' => ''.e(old('date', $attendances->date ?? '')).'','class' => 'mt-2']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.form-input'); ?>
<?php if ($component->shouldRender()): ?>
<?php $__env->startComponent($component->resolveView(), $component->data()); ?>
<?php if (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag): ?>
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'date','name' => 'date','value' => ''.e(old('date', $attendances->date ?? '')).'','class' => 'mt-2']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__attributesOriginal40054831fd8fc1521987609af4b37cc0)): ?>
<?php $attributes = $__attributesOriginal40054831fd8fc1521987609af4b37cc0; ?>
...
<?php $component->withAttributes(['name' => 'status','class' => 'mt-2']); ?>
                                ...
                                <option value="active" <?php echo e(old('status', $attendances->status ?? '') == 'active' ? 'selected' : ''); ?>><?php echo e(__('global.active')); ?></option>
                                <option value="inactive" <?php echo e(old('status', $attendances->status ?? '') == 'inactive' ? 'selected' : ''); ?>><?php echo e(__('global.inactive')); ?></option>
                                <option value="pending" <?php echo e(old('status', $attendances->status ?? '') == 'pending' ? 'selected' : ''); ?>><?php echo e(__('global.pending')); ?></option>
                                <option value="draft" <?php echo e(old('status', $attendances->status ?? '') == 'draft' ? 'selected' : ''); ?>><?php echo e(__('global.draft')); ?></option>
                             <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php $attributes = $attributes->except(\Illuminate\View\AnonymousComponent::ignoredParameterNames()); ?>
<?php endif; ?>
<?php $component->withAttributes(['name' => 'notes','rows' => '4','class' => 'resize-none']); ?><?php echo e(old('notes', $attendances->notes ?? '')); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\deebo\Source\resources\views\pages\attendances\edit.blade.php ENDPATH**/ ?>