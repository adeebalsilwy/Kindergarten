...
<?php $__env->startSection('subcontent'); ?>
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto"><?php echo e(__('Attendance.show')); ?></h2>
    </div>
        ...
        <div class="intro-y col-span-12 lg:col-span-10">
            <div class="intro-y box p-5">
                <div class="grid grid-cols-12 gap-4">
                    ...
                    <?php $__currentLoopData = $attendances->toArray(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php endif; ?>
<?php $component->withAttributes([]); ?><?php echo e(__('Attendance.fields.'.$key)); ?> <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                ...
                <div class="flex justify-end mt-5">
                    <a href="<?php echo e(route('attendances.index')); ?>" class="btn btn-outline-secondary w-24 mr-1"><?php echo e(__('global.back')); ?></a>
                    <a href="<?php echo e(route('attendances.edit', $attendances->id)); ?>" class="btn btn-primary w-24"><?php echo e(__('global.edit')); ?></a>
                </div>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\deebo\Source\resources\views\pages\attendances\show.blade.php ENDPATH**/ ?>