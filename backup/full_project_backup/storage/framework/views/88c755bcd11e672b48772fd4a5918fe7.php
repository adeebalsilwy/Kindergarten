...
<?php endif; ?>
<?php $component->withAttributes([]); ?>
                            <x-base.table.td colspan="{{ count(array_filter(explode("\n", trim('                            <?php if (isset($component)) { $__componentOriginalbf9f34089dac534fce4e82b41f223670 = $component; } ?>
<?php if (isset($attributes)) { $__attributesOriginalbf9f34089dac534fce4e82b41f223670 = $attributes; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.base.table.th','data' => ['class' => 'whitespace-nowrap text-center']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? $attributes->all() : [])); ?>
<?php $component->withName('base.table.th'); ?>
<?php if ($component->shouldRender()): ?>
...
<?php endif; ?> 
                    ...
                    <div class="text-3xl font-bold leading-8 mt-6">
                        <?php
                            $recentCount = $caches->where('created_at', '>=', now()->subDays(7))->count();
                        ?>
...
<?php endif; ?> 
                    ...
                    <div class="text-3xl font-bold leading-8 mt-6">
                        <?php
                            $todayCount = $caches->whereDate('created_at', today())->count();
                        ?>
...
<?php echo $__env->make('../themes/' . $activeTheme . '/' . $activeLayout, array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\xampp\htdocs\deebo\Source\resources\views\pages\cache\index.blade.php ENDPATH**/ ?>