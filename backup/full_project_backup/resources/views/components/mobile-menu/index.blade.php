                ...
                @else
                    <li>
                        <a
                            ...
                            href="{{ (isset($menu['route_name']) && Route::has($menu['route_name'])) ? route($menu['route_name'], isset($menu['params']) ? $menu['params'] : []) : 'javascript:;' }}"
                        >
                                ...
                                @foreach ($menu['sub_menu'] as $subMenuKey => $subMenu)
                                    <li>
                                        <a
                                            ...
                                            href="{{ (isset($subMenu['route_name']) && Route::has($subMenu['route_name'])) ? route($subMenu['route_name'], isset($subMenu['params']) ? $subMenu['params'] : []) : 'javascript:;' }}"
                                        >
                                            <div class="menu__icon">
                                                ...
                                                @foreach ($subMenu['sub_menu'] as $lastSubMenuKey => $lastSubMenu)
                                                    <li>
                                                        <a
                                                            ...
                                                            href="{{ (isset($lastSubMenu['route_name']) && Route::has($lastSubMenu['route_name'])) ? route($lastSubMenu['route_name'], isset($lastSubMenu['params']) ? $lastSubMenu['params'] : []) : 'javascript:;' }}"
                                                        >
                                                            <div class="menu__icon">
