                        ...
                        <x-base.table.tr class="intro-x">
                            ...
                            <x-base.table.td class="table-report__action w-56">
                                <div class="flex justify-center items-center">
                                    ...
                                    <x-base.button variant="outline-secondary" as="a" href="{{ route('financial_reports.show', $financialReports->id) }}" size="sm" class="mr-2">
                                    ...
                                    <x-base.button variant="outline-primary" as="a" href="{{ route('financial_reports.edit', $financialReports->id) }}" size="sm" class="mr-2">
                                    ...
                                    <form action="{{ route('financial_reports.destroy', $financialReports->id) }}" method="POST" onsubmit="return confirm('{{ __('global.confirm_delete') }}')" class="inline">
                                        @csrf
                                        @method('DELETE')
