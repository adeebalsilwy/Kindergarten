...
@section('subcontent')
    ...
    <div class="intro-y box mt-5 p-6" id="edit-app">
        ...
        <div class="mb-8 border-b border-slate-200/60 pb-5 dark:border-darkmode-400 bg-gradient-to-r from-slate-50 to-white dark:from-darkmode-500/20 dark:to-darkmode-600 p-5 rounded-lg shadow-sm">
            <div class="flex flex-col sm:flex-row items-end gap-4">
                <div class="w-full sm:w-1/3">
                    <x-base.form-label class="font-medium text-slate-700 dark:text-slate-300 mb-2">Select Model/Table</x-base.form-label>
                    <x-base.tom-select id="target-table-select" class="w-full rounded-lg" data-placeholder="Select a table...">
        ...
        <form id="edit-form" class="hidden" method="POST" action="{{ route('crud-builder.generate') }}">
            @csrf
                    ...
                    <div class="box p-6 border border-slate-200/60 shadow-lg dark:border-darkmode-400 bg-gradient-to-br from-slate-50 to-white dark:from-darkmode-500/20 dark:to-darkmode-600">
                        ...
                        <div class="grid grid-cols-12 gap-5">
                            <div class="col-span-12 sm:col-span-6">
                                <x-base.form-label class="font-medium text-slate-700 dark:text-slate-300 mb-2">Model Name</x-base.form-label>
                                <x-base.form-input id="model_name" name="model_name" type="text" readonly class="py-3 px-4 text-sm rounded-lg border-2 border-slate-200 focus:border-blue-500 dark:border-darkmode-300 dark:bg-darkmode-700 dark:text-slate-200 bg-slate-100 cursor-not-allowed" />
                            </div>
                            <div class="col-span-12 sm:col-span-6">
                                <x-base.form-label class="font-medium text-slate-700 dark:text-slate-300 mb-2">Table Name</x-base.form-label>
                                <x-base.form-input id="table_name" name="table_name" type="text" readonly class="py-3 px-4 text-sm rounded-lg border-2 border-slate-200 focus:border-blue-500 dark:border-darkmode-300 dark:bg-darkmode-700 dark:text-slate-200 bg-slate-100 cursor-not-allowed" />
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="box p-6 border border-slate-200/60 shadow-lg dark:border-darkmode-400 bg-gradient-to-br from-slate-50 to-white dark:from-darkmode-500/20 dark:to-darkmode-600">
                        ...
                        <div class="space-y-4" id="new-fields-container">
                            ...
                            <div class="text-slate-500 text-center py-10 bg-slate-50 rounded-xl border-2 border-dashed border-slate-300 italic" id="no-new-fields-msg">
                                <x-base.lucide icon="FilePlus" class="w-10 h-10 mx-auto mb-3 text-slate-300" />
                        ...
                        <div class="grid grid-cols-12 gap-4">
                            <div class="col-span-12">
                                <x-base.tom-select 
                                    ...
                                    name="components[]" 
                                    multiple 
                                    data-placeholder="Select components...">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadColumns(table, selectElement) {
                ...
                fetch(`{{ route('crud-builder.columns') }}?table=${table}`)
                    .then(res => res.json())
                    .then(columns => {
