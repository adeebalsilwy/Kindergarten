...
<head>
    ...
    <title>{{ __('dashboard_contents.title') }} - {{ config('app.name') }}</title>
    <style>
        body {
...
<body>
    <div class="container">
        <div class="header">
            ...
            <p>{{ __('dashboard_contents.title') }} - {{ __('global.export_excel') }}</p>
        </div>
...
{{tableHeaders}}
            ...
            <tbody>
                @foreach(${{'{{variableNamePlural}}'}} as ${{'dashboardContents'}})
                <tr>
{{tableBody}}
                </tr>
                @endforeach
