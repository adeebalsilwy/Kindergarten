...
@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">{{ __('DashboardContent.show') }}</h2>
    </div>
        ...
        <div class="intro-y col-span-12 lg:col-span-10">
            <div class="intro-y box p-5">
                <div class="grid grid-cols-12 gap-4">
                    ...
                    @foreach($dashboardContents->toArray() as $key => $value)
                ...
                <div class="flex justify-end mt-5">
                    <a href="{{ route('dashboard_contents.index') }}" class="btn btn-outline-secondary w-24 mr-1">{{ __('global.back') }}</a>
                    <a href="{{ route('dashboard_contents.edit', $dashboardContents->id) }}" class="btn btn-primary w-24">{{ __('global.edit') }}</a>
                </div>
            </div>
        </div>
    </div>
