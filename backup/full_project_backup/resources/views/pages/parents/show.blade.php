...
@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">{{ __('kindergarten.parents.view') }}</h2>
    </div>
        ...
        <div class="intro-y col-span-12 lg:col-span-10">
            <div class="intro-y box p-5">
                ...
                <div class="flex justify-end mt-5">
                    <a href="{{ route('parents.index') }}" class="btn btn-outline-secondary w-24 mr-1">{{ __('global.back') }}</a>
