                            ...
                            <div class="report-box zoom-in before:box before:absolute before:inset-x-3 before:mt-3 before:h-full before:bg-slate-50 before:content-['']">
                                <div class="box p-5">
                                    ...
                                    <div class="mt-6 text-2xl font-medium leading-8 text-slate-600 dark:text-slate-300">
                                        {{ __('global.currency_symbol', ['amount' => number_format($currentMonth['revenue']['total_revenue'] ?? 0)]) }}
                                    </div>
                        ...
                        <div class="flex flex-col md:flex-row md:items-center">
                            <div class="flex">
                                <div>
                                    ...
                                    <div class="mt-0.5 text-slate-500">{{ $currentMonth['period']['formatted'] ?? 'This Month' }}</div>
                                </div>
                                <div
                                ...
                                <div>
                                    <div class="text-lg font-medium text-danger xl:text-xl">
                                        {{ __('global.currency_symbol', ['amount' => number_format($currentMonth['expenses']['total_expenses'] ?? 0)]) }}
                                    </div>
