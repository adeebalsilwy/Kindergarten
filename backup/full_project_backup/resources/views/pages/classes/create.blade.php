...
@section('head')
    <title>{{ __('kindergarten.classes.add_new') }} - {{ config('app.name') }}</title>
@endsection

@section('subcontent')
    <div class="intro-y flex items-center mt-8">
        <h2 class="text-lg font-medium mr-auto">{{ __('kindergarten.classes.add_new') }}</h2>
    </div>
            ...
            <div class="intro-y box p-5">
                <form action="{{ route('classes.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-12 gap-4">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            <x-base.form-label>{{ __('kindergarten.classes.capacity') }}</x-base.form-label>
                            <x-base.form-input type="number" name="capacity" value="{{ old('capacity', $classes->capacity ?? '') }}" class="mt-2" />
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            <x-base.form-label>{{ __('kindergarten.classes.current_count') }}</x-base.form-label>
                            <x-base.form-input type="number" name="current_students" value="{{ old('current_students', $classes->current_students ?? '') }}" class="mt-2" />
                        </div>
                        <div class="col-span-12 sm:col-span-6">
                            <x-base.form-label>{{ __('kindergarten.classes.start_time') }}</x-base.form-label>
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            <x-base.form-label>{{ __('kindergarten.classes.end_time') }}</x-base.form-label>
                            <div class="relative mt-2">
                        ...
                        <div class="col-span-12 sm:col-span-6">
                            ...
                            <div class="mt-2 space-y-2">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer">
                                    ...
                                    <span class="ml-3 text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('kindergarten.classes.active') }}</span>
                                </label>
                            </div>
                        </div>
