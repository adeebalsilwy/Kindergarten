...
@section('subcontent')
    <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
        ...
        <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
            <x-base.button variant="outline-primary" as="a" href="{{ route('users.export.pdf') }}?report_type=account_statement" class="flex items-center mr-2">
                <x-base.lucide icon="FileText" class="w-4 h-4 mr-2" />
                {{ __('global.export_pdf') }}
            </x-base.button>
            <x-base.button variant="outline-success" as="a" href="{{ route('users.export.excel') }}?report_type=account_statement" class="flex items-center">
    ...
    <div class="grid grid-cols-12 gap-6 mt-5">
        ...
        <div class="intro-y col-span-12">
            <div class="box p-5">
                <form method="GET" action="{{ route('users.account-statement') }}">
